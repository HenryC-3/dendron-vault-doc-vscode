...
MetaDescription: >-
  Visual Studio Code Remote Development Frequently Asked Questions (FAQ) for
  SSH, Containers, and WSL
DateApproved: 8/4/2022
---
# Remote Development FAQ

This article covers frequently asked questions for each of the **Visual Studio Code Remote Development** extensions. See the [[vs.1.7.docs.remote.ssh]], [[v[[vs.1.7.docs.remote.containers]]nd [[vs.1[[vs.1.7.docs.remote.wsl]]les for more details on setting up and working with each of their respective capabilities. Or try the introductory [[vs.1.7.[[vs.1.7.docs.remote.ssh-tutorial]]get you running quickly in a remote environment.
...
![Architecture summary](/assets/architecture-iu4o3rac2isj.png)

See [[vs.1.7.api.advanced-topics.remote-extensions]] for additional details about extensions.
...
You can find a list of locations VS Code itself needs access to in the [[vs.1.7.docs.setup.network.md#common-hostnames]].
...
* Install the [Remote - Containers](https://aka.ms/vscode-remote/download/containers) extension and use the [[vs.1.7.docs.remote.containers.md#managing-containers]] in situations when you need to see your local containers.
...
* Use the [[vs.1.7.docs.remote.containers.md#advanced-forcing-an-extension-to-run-locally-or-remotely]] to force the extension to be `ui`. However, this will prevent some commands from working.
...
See [[vs.1.7.docs.remote.linux]] for additional details.
...
The [vscode-dev-containers repository](https://aka.ms/vscode-dev-containers) includes a set of dev container definitions for some common development environments. You can also [[vs.1.7.docs.remote.attach-container]] without setting up a dev container definition, if you prefer to use an alternate container build or deployment workflow.
...
The VS Code extension API abstracts away local/remote details so most extensions will work without modification. However, given extensions can use any node module or runtime they want, there are situations where adjustments may need to be made. We recommend you should test your extension (particularly in a container) to be sure that no updates are required. See [[vs.1.7.api.advanced-topics.remote-extensions]] for details.
...
If your extension is not functioning as expected, [[vs.1.7.api.advanced-topics.remote-extensions#incorrect-execution-location]] if it is running in the correct location or should perhaps have a different `extensionKind`. Also see [[vs.1.7.api.advanced-topics.remote-extensions]] for additional details on what extension authors need to know about Remote Development and Codespaces.
...
See the [Visual Studio Code and 'Code - OSS' Differences](https://github.com/microsoft/vscode/wiki/Differences-between-the-repository-and-Visual-Studio-Code) and [[vs.1.7.docs.supporting.oss-extensions]] articles for more information.
...
Please email us at [[vs.1.7.mailto:vscode@microsoft.com]] with any questions you may have.

### GDPR and VS Code Remote Development

The VS Code Remote Development extensions follow the GDPR policies as Visual Studio Code itself. See the [[vs.1.7.docs.supporting.faq.md#gdpr-and-vs-code]] for more details.

## Questions or feedback

Have a question or feedback?

* See [[vs.1.7.docs.remote.troubleshooting]].
