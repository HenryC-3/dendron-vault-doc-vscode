...
- Use [[vs.1.7.insiders]] release of VS Code.
...
![Demo showing a user going into the Extensions view to find the Install from VSIX menu item](/assets/install-from-vsix-8irzbujiokef.gif)
