...
Visual Studio Code is a source code editor first and foremost with rich editing [[vs.1.7.docs.editor.codebasics]]. In this document, we will go through a few Java-specific features, which are helpful when working with Java.

If you run into any issues when using the features below, you can contact us by entering an [issue](https://github.com/microsoft/vscode-java-pack/issues).

## Code navigation

With the [[vs.1.7.docs.getstarted.userinterface.md#outline-view]], you can conveniently navigate the members within the current file. [[vs.1.7.docs.java.java-project.md#projects-view]] also provide a great overview of your project. As a Java editor, it also supports Call Hierarchy, Type Hierarchy, Definition Navigation, Search Types in Workspace, etc.
...
![Spring Navigation](/assets/goto-super-c05s72ets7n9.png)
...
![Call Hierarchy Peek](/assets/call-hierarchy-09rhk0p6r4mu.png)

You can also right-click in a function body and pick **Show Call Hierarchy**.

![Call Hierarchy Menu](/assets/call-hierarchy-v6kox3zoqwlg.gif)
...
![Semantic Highlighting](/assets/semantic-highlighting-0cqehz900eye.png)
...
![Spring Navigation](/assets/spring-navigation-zy6y4ef5cgqp.png)

To learn more about Spring Boot support with Visual Studio Code, read [[vs.1.7.docs.java.java-spring-boot]].
...
For more details about refactoring and code actions, see [[vs.1.7.docs.java.java-refactoring]].
...
![Code Snippet](/assets/code-snippet-wujwrbev4q0x.png)
