...
MetaDescription: >-
  A quick overview of the Visual Studio Code user interface. Learn about the
  editor, window management, and special UI to handle source control, extension
  management, full text search and more.
---
# User Interface

At its heart, Visual Studio Code is a code editor. Like many other code editors, VS Code adopts a common user interface and layout of an explorer on the left, showing all of the files and folders you have access to, and an editor on the right, showing the content of the files you have opened.

![code basics hero](/assets/hero-7klcwbfdb8d0.png)
...
Open files in each editor are displayed with tabbed headers (Tabs) at the top of the editor region. To learn more about tabbed headers, see the [[vs.1.7.docs.getstarted.userinterface.md#tabs]] section below.
...
![Side by Side editing](/assets/sidebyside-odr6nbcp1x82.png)
...
![minimap](/assets/minimap-9i9x15dnhl20.png)

>**Tip:** You can move the minimap to the left hand side or disable it completely by respectively setting `"editor.minimap.side": "left"` or `"editor.minimap.enabled": false` in your user or workspace [[vs.1.7.docs.getstarted.settings]].

### Indent Guides

The image above also shows indentation guides (vertical lines) which help you quickly see matching indent levels. If you would like to disable indent guides, you can set `"editor.guides.indentation": false` in your user or workspace [[vs.1.7.docs.getstarted.settings]].
...
![Explorer Menu](/assets/explorer_menu-tti59nmby72v.png)
...
By default, VS Code excludes some folders from the Explorer (for example. `.git`). Use the `files.exclude` [[vs.1.7.docs.getstarted.settings]] to configure rules for hiding files and folders from the Explorer.
...
![Filtering files in the File Explorer](/assets/file-explorer-filter-t53oocsx6s65.png)
...
![Outline view](/assets/outline-view-ouy4y1qpy0gs.png)
...
![Markdown Outline view](/assets/markdown-outline-view-44altrttv3w7.png)

There are several Outline view [[vs.1.7.docs.getstarted.settings]] which allow you to enable/disable icons and control the errors and warnings display (all enabled by default):
...
![activity bar context menu](/assets/activity-bar-context-menu-736lylkwhvcz.png)
...
![Command Palette](/assets/commands-eu1w7wnf9yud.png)
...
![Quick Open Help](/assets/quickopenhelp-uquyt0lhbgef.png)
...
Most editor configurations are kept in settings which can be modified directly. You can set options globally through user settings or per project/folder through workspace settings. Settings values are kept in a `settings.json` [[vs.1.7.docs.getstarted.settings.md#settingsjson]].
...
![tabs hero](/assets/tabs-hero-btf1ttxokb8o.png)
...
If you don't want to use Tabs, you can disable the feature by setting the `workbench.editor.showTabs` [[vs.1.7.docs.getstarted.settings]] to false:

```json
    "workbench.editor.showTabs": false
```

See the section below to optimize VS Code when [[vs.1.7.docs.getstarted.userinterface.md#working-without-tabs]].
...
![preview mode](/assets/preview-tab-x2uky3czxrk9.png)
...
![tabs editor groups](/assets/tabs-editor-groups-yk17db70i55w.png)
...
![Grid Editor Layout](/assets/grid-layout-c2ocn8tboz57.gif)

To support flexible layouts, you can create empty editor groups. By default, closing the last editor of an editor group will also close the group itself, but you can change this behavior with the new setting `workbench.editor.closeEmptyGroups: false`:

![Grid Empty](/assets/grid-empty-hi7avl6n5bz2.png)

There are a predefined set of editor layouts in the new **View** > **Editor Layout** menu:

![Grid Editor Layout Menu](/assets/grid-layout-menu-dp4ghewqhzw7.png)
...
![Grid Editor Drag and Drop](/assets/grid-dnd-oi0pelgtvgza.gif)
...
![Grid Alt Click](/assets/grid-alt-qytk2gafi9ta.gif)

### Keyboard shortcuts

Here are some handy keyboard shortcuts to quickly navigate between editors and editor groups.

>If you'd like to modify the default keyboard shortcuts, see [[vs.1.7.docs.getstarted.keybindings]] for details.
...
Edit your [[vs.1.7.docs.getstarted.keybindings]] and add the following:
...
If you liked the behavior of VS Code closing an entire group when closing one editor, you can bind the following in your [[vs.1.7.docs.getstarted.keybindings]].
...
* [[vs.1.7.docs.getstarted.themes]] - Set a Color and/or File Icon theme to your preference.

## Common questions

### How can I change the color of the indent guides?

The indent guide colors are customizable as are most VS Code UI elements. To [[vs.1.7.api.references.theme-color]] the indent guides color for your active color theme, use the `workbench.colorCustomizations` [[v[[vs.1.7.docs.getstarted.settings]]d modify the `editorIndentGuide.background` value.
