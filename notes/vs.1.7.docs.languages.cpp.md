...
![cpp extension](/assets/cpp-extension-eya4g7xbxp17.png)
...
![Search for c++ in the Extensions view](/assets/search-cpp-extension-n9dsz47970eb.png)
...
![C++ language features](/assets/msg-intellisense-43mpf8k65p2b.png)
...
The "code ." command opens VS Code in the current working folder, which becomes your "workspace". Accept the [[vs.1.7.docs.editor.workspace-trust]] dialog by selecting **Yes, I trust the authors** since this is a folder you created.

Now create a new file called `helloworld.cpp` with the **New File** button in the File Explorer or **File** > **New File** command.

![File Explorer New File button](/assets/new-file-ndhy7yax5n2y.png)

![helloworld.cpp file](/assets/hello-world-cpp-ehlcdcxdb6if.png)
...
Now press `kb(workbench.action.files.save)` to save the file. You can also enable [[vs.1.7.docs.editor.codebasics.md#save-auto-save]] to automatically save your file changes, by checking **Auto Save** in the main **File** menu.
...
![Run Build Task menu option](/assets/run-build-task-rh4hm1aj4lcc.png)
...
![Select g++.exe task](/assets/gpp-build-task-msys64-84v6tsdnfpuh.png)
...
![helloworld.exe in the File Explorer](/assets/hello-world-exe-0r27ca3pd6ql.png)

### Run Hello World

From a command prompt or a new VS Code Integrated Terminal, you can now run your program by typing ".\helloworld".

![Run hello world in the VS Code Integrated Terminal](/assets/run-hello-world-69zyezqc6ima.png)
...
- [[vs.1.7.docs.cpp.cmake-linux]]

## Documentation

You can find more documentation on using the Microsoft C/C++ extension under the [[vs.1.7.docs.cpp]] of the VS Code website, where you'll find topics on:

- [[vs.1.7.docs.cpp.cpp-debug]]
- [[vs.1.7.docs.cpp.cpp-ide]]
- [[vs.1.7.docs.cpp.customize-default-settings-cpp]]
- [[vs.1.7.docs.cpp.faq-cpp]]

![C++ TOC on code.visualstudio.com](/assets/cpp-toc-wccr261ykbsf.png)

## Remote Development

VS Code and the C++ extension support [[vs.1.7.docs.remote.remote-overview]] allowing you to work over SSH on a remote machine or VM, inside a Docker container, or in the [Windows Subsystem for Linux](https://docs.microsoft.com/windows/wsl) (WSL).
