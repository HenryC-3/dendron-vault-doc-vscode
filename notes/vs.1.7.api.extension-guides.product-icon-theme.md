...
A list of all icon identifiers can be found in the [[vs.1.7.api.references.icons-in-labels#icon-listing]].
...
![dev tools inspect tool](/assets/dev-tool-select-tool-sszgx6sanl9m.png)
