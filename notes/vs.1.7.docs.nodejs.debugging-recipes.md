...
![Node.js logo](/assets/nodejs-qiskblh3hpez.png)
...
![JavaScript, Edge, and Chrome logo](/assets/browsers-pxwt3wzpi8yc.png)

You can read more about debugging browsers works in the [[vs.1.7.docs.nodejs.browser-debugging]].
...
![electron logo](/assets/electron-2uown7jwylqk.png)
...
* [[vs.1.7.docs.nodejs.nodejs-debugging]] - Learn about the built-in Node.js debugger.
