...
Visual Studio Code can create and start containers for you but that may not match your workflow and you may prefer to "attach" VS Code to an already running Docker container - regardless of how it was started. Once attached, you can install extensions, edit, and debug like you can when you open a folder in a container using [[vs.1.7.docs.remote.devcontainerjson-reference]].
...
See the [[vs.1.7.docs.remote.devcontainerjson-reference.md#attached-container-configuration-reference]] for a complete list of properties and their uses.
...
Finally, if you have extensions you want installed regardless of the container you attach to, you can update `settings.json` to specify a list of [[vs.1.7.docs.remote.containers.md#always-installed-extensions]].
...
![Attach to Kubernetes Container](/assets/k8s-attach-vexbzckmvei7.png)
