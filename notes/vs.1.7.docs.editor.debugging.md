...
MetaDescription: >-
  One of the great things in Visual Studio Code is debugging support.  Set
...
![Debugging diagram](/assets/debugging_hero-rtrqbuatpfsd.png)
...
It is helpful to first create a sample Node.js application before reading about debugging. You can follow the [[vs.1.7.docs.nodejs.nodejs-tutorial]] to install Node.js and create a simple "Hello World" JavaScript application (`app.js`). Once you have a simple application set up, this page will take you through VS Code debugging features.
...
![Run and Debug icon](/assets/run-hvun8vrdfh14.png)
...
![Simplified initial Run and Debug view](/assets/debug-start-y2ecwpsglfpc.png)

## Run menu

The top-level **Run** menu has the most common run and debug commands:

![Run menu](/assets/debug-menu-ng6auagj5mpz.png)
...
However, for most debugging scenarios, creating a launch configuration file is beneficial because it allows you to configure and save debugging setup details. VS Code keeps debugging configuration information in a `launch.json` file located in a `.vscode` folder in your workspace (project root folder) or in your [[vs.1.7.docs.editor.debugging.md#global-launch-configuration]] or [[vs.1.7.docs.editor.multi-root-workspaces.md#workspace-launch-configurations]].

To create a `launch.json` file, click the **create a launch.json file** link in the Run start view.

![launch configuration](/assets/launch-configuration-6otsw70a89es.png)

VS Code will try to automatically detect your debug environment, but if this fails, you will have to choose it manually:

![debug environment selector](/assets/debug-environments-ii8kfc3kn8tk.png)
...
![launch.json in Explorer](/assets/launch-json-in-explorer-loxidur5siyd.png)
...
![launch.json IntelliSense](/assets/launch-json-intellisense-bv95m5o4jupz.png)
...
![debug session](/assets/debug-session-z7zkozy35rmu.png)
...
![Debug status](/assets/debug-status-vpeibmgslcue.png)

## Debug actions

Once a debug session starts, the **Debug toolbar** will appear on the top of the editor.

![Debug Actions](/assets/toolbar-mg137x0baziy.png)
...
![Breakpoints](/assets/breakpoints-jkde4t4hvc7o.png)
...
![breakpoints in overview ruler](/assets/bpts-in-overview-hvymyiux0pab.png)
...
![Logpoints](/assets/log-points-mwc8aez6afmb.gif)

Just like regular breakpoints, Logpoints can be enabled or disabled and can also be controlled by a condition and/or hit count.

**Note**: Logpoints are supported by VS Code's built-in Node.js debugger, but can be implemented by other debug extensions. The [[vs.1.7.docs.python.python-tutorial]] and [[v[[vs.1.7.docs.java.java-tutorial]]tensions, for example, support Logpoints.
...
![Debug Variables](/assets/variables-17k2a2bk6p58.png)
...
![Debug Watch](/assets/watch-o175ign8zss5.png)

Variable names and values can be filtered by typing while the focus is on the **VARIABLES** section.

![Filtering in the Variables section](/assets/filtering-variables-vzuk8dl63t49.png)
...
![launch json suggestions](/assets/launch-json-suggestions-d69nt0lpzj9w.png)
...
* `preLaunchTask` - to launch a task before the start of a debug session, set this attribute to the label of a task specified in [[vs.1.7.docs.editor.tasks]] (in the workspace's `.vscode` folder). Or, this can be set to `${defaultBuildTask}` to use your default build task.
...
VS Code supports adding a `"launch"` object inside your User [[vs.1.7.docs.getstarted.settings]]. This `"launch"` configuration will then be shared across your workspaces. For example:
...
![HitCount](/assets/hitcount-xxjia8vlnj81.gif)
...
![condition editing in breakpoint view](/assets/breakpoints-7gtd1fus9cjl.gif)
...
![Debug Console](/assets/debugconsole-rmbf3ushksg7.png)
...
* The individual sessions now show up as top-level elements in the **CALL STACK** view.<BR>![Callstack View](/assets/debug-callstack-j9wfnnyg1wrx.png)
* The debug toolbar shows the currently **active session** (and all other sessions are available in a dropdown menu).<BR>![Debug Actions Widget](/assets/debug-actions-widget-63dqbhr9n8kx.png)
...
There is, however, one exception: the Node.js debugger included in VS Code supports remote debugging. See the [[vs.1.7.docs.nodejs.nodejs-debugging.md#remote-debugging]] topic to learn how to configure this.
...
![Server ready feature in action](/assets/server-ready-pnelflwecath.gif)

## Next steps

To learn about VS Code's Node.js debugging support, take a look at:

* [[vs.1.7.docs.nodejs.nodejs-debugging]] - Describes the Node.js debugger, which is included in VS Code.
* [[vs.1.7.docs.typescript.typescript-debugging]] - The Node.js debugger also supports TypeScript debugging.

To see tutorials on the basics of Node.js debugging, check out these videos:

* [[vs.1.7.docs.introvideos.debugging]] - Showcases the basics of debugging.
...
* [[vs.1.7.docs.cpp.cpp-debug]]
* [[vs.1.7.docs.python.debugging]]
* [[vs.1.7.docs.java.java-debugging]]

To learn about VS Code's task running support, go to:

* [[vs.1.7.docs.editor.tasks]] - Describes how to run tasks with Gulp, Grunt, and Jake and how to show errors and warnings.

To write your own debugger extension, visit:

* [[vs.1.7.api.extension-guides.debugger-extension]] - Uses a mock sample to illustrate the steps required to create a VS Code debug extension.
