...
![Language Pack recommendation](/assets/lang-pack-recommendation-54utrww71jpq.png)
...
>**Note**: This topic explains how to change the display language in the VS Code UI via Language Packs such as French or Chinese. If you want to add programming language support, for example for C++ or Java, refer to the [[vs.1.7.docs.languages.overview]] section of the documentation.
...
![German Language Pack](/assets/german-language-pack-l2jjkwkskgrv.png)
...
Refer to the [[vs.1.7.docs.languages.overview]] section to learn how to install support for programming languages, such as PHP, Python, and Java.
