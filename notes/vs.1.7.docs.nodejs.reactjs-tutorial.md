...
MetaDescription: >-
  React JavaScript tutorial showing IntelliSense, debugging, and code navigation
  support in the Visual Studio Code editor.
...
![Welcome to React](/assets/welcome-to-react-jhh8unybhbmk.png)
...
You should see the React logo and a link to "Learn React" on [[vs.1.7.http:..localhost:3000]] in your browser. We'll leave the web server running while we look at the application with VS Code.
...
![React bracket matching](/assets/bracket-matching-qzgkzf84skb0.png)

### IntelliSense

As you start typing in `index.js`, you'll see smart suggestions or completions.

![React IntelliSense suggestions](/assets/suggestions-tp0jtxjy25c7.png)
...
![React IntelliSense](/assets/intellisense-2b67ymhjmppm.png)
...
![React parameter help](/assets/parameter-help-1pzzlco7u886.png)

### Go to Definition, Peek definition

Through the TypeScript language service, VS Code can also provide type definition information in the editor through **Go to Definition** (`kb(editor.action.revealDefinition)`) or **Peek Definition** (`kb(editor.action.peekDefinition)`). Put the cursor over the `App`, right click and select **Peek Definition**. A [[vs.1.7.docs.editor.editingevolved.md#peek]] will open showing the `App` definition from `App.js`.

![React Peek definition](/assets/peek-definition-d4p82bxfn5ay.png)
...
![Hello, world](/assets/hello-world-eujg9kdvp6cr.png)
...
![Set a breakpoint](/assets/breakpoint-v6u1z9cvlwy4.png)
...
![Debugger hitting breakpoint](/assets/hit-breakpoint-eciu8hshihv0.png)
...
![Debug element variable](/assets/debug-variable-g53kt2txujn8.png)
...
![JavaScript error](/assets/js-error-1c9m8g9ahbiv.png)
...
![ESLint extension](/assets/eslint-extension-qxwyar2s7lt1.png)
...
![Find the configuration command](/assets/create-eslintrc-zkqgkc17u9b2.png)
...
![App is unused](/assets/app-is-unused-yrsjlk1atzs2.png)
...
![Extra semicolon error](/assets/extra-semi-error-ht3nl87rw7em.png)
...
![JSX IntelliSense](/assets/jsx-intellisense-imfdp3ddmkub.png)
