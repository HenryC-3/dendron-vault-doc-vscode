...
![Working with TypeScript in Visual Studio Code](/assets/overview-y21o0939xmv4.png)
...
![create new file](/assets/create-new-file-htn5arzlcfuf.png)
...
To compile your TypeScript code, you can open the [[vs.1.7.docs.terminal.basics]] (`kb(workbench.action.terminal.toggleTerminal)`) and type `tsc helloworld.ts`. This will compile and create a new `helloworld.js` JavaScript file.

![compiled hello world](/assets/compiled-hello-world-rc3ef3cf39ah.png)

If you have Node.js installed, you can run `node helloworld.js`.

![run hello world](/assets/run-hello-world-p1v9w3utfh0h.png)
...
![TypeScript small completions for String type](/assets/ts-intellisense-axiuz2q8h9a0.png)
...
![Hover for a lodash function](/assets/hover-gfcugje99px3.png)
...
![Signature help for the lodash capitalize function](/assets/signature-help-cj5z1wk87qqx.png)
...
In addition to smart code completions, VS Code also includes basic TypeScript [[vs.1.7.docs.editor.userdefinedsnippets]] that are suggested as you type.

![TypeScript 'for' snippet suggestions](/assets/ts-snippets-w89zqeemsjy6.png)
...
![Error in the editor and Problems panel](/assets/ts-error-ajzd1so1jtgv.png)
...
![Error inline in the editor](/assets/ts-error-inline-une7eewp4neu.png)
...
![TypeScript refactoring](/assets/refactorings-uajxux77xdqd.png)

See [[vs.1.7.docs.typescript.typescript-refactoring]] for more information about refactorings and how you can configure keyboard shortcuts for individual refactorings.
...
![Renaming a method](/assets/rename-o3fzdo79olbw.png)

## Debugging

VS Code comes with great debugging support for TypeScript, including support for sourcemaps. Set breakpoints, inspect objects, navigate the call stack, and execute code in the Debug Console. See the [[vs.1.7.docs.editor.debugging]] to learn more.

### Debug client side

You can debug your client-side code using a browser debugger such as the [[vs.1.7.docs.nodejs.browser-debugging]], or the [Debugger for Firefox](https://marketplace.visualstudio.com/items?itemName=hbenl.vscode-firefox-debug).
...
[Linters](https://en.wikipedia.org/wiki/Lint_%28software%29) provides warnings for suspicious looking code. While VS Code does not include a built-in TypeScript linter, TypeScript linter [[vs.1.7.docs.editor.extension-marketplace]] available in the Marketplace.

[ESLint](https://eslint.org) is a popular linter, which also supports TypeScript. The [ESLint extension](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint) integrates ESLint into VS Code so you can see linting errors right in the editor and even quickly many of fix them with [[vs.1.7.docs.typescript.typescript-refactoring.md#quick-fixes]]. The [ESLint plugin guide](https://github.com/typescript-eslint/typescript-eslint/tree/main/packages/eslint-plugin#readme) details how to configure ESLint for your TypeScript projects.
...
* [[vs.1.7.docs.typescript.typescript-tutorial]] - Create a simple Hello World TypeScript in VS Code.
* [[vs.1.7.docs.typescript.typescript-editing]] - Specific editing features for TypeScript.
* [[vs.1.7.docs.typescript.typescript-refactoring]] - Useful refactorings from the TypeScript language service.
* [[vs.1.7.docs.typescript.typescript-compiling]] - Compile TypeScript to a JavaScript target version.
* [[vs.1.7.docs.typescript.typescript-debugging]] - Learn about debugging TypeScript both server and client-side with VS Code.
...
You can also [[vs.1.7.docs.typescript.typescript-compiling.md#using-newer-typescript-versions]].
