---
id: lyj3qifqq5w3om4ptfl6c7a
title: Configure Intellisense Crosscompilation
desc: ''
...
MetaDescription: >-
  Configure Visual Studio Code c_cpp_properties.json to get IntelliSense when
  you are compiling for a different platform
---
...
![Compiler path setting](/assets/compiler-path-buw8v8d9z3t3.png)
...
![IntelliSense mode setting](/assets/intellisense-mode-p4fp323jvx4d.png)
...
![Include path setting](/assets/include-path-8g0jtu48xjrd.png)
...
- For more information about IntelliSense configuration, see [[vs.1.7.docs.cpp.customize-default-settings-cpp]].
...
- Explore the [[vs.1.7.docs.cpp.c-cpp-properties-schema-reference]].
