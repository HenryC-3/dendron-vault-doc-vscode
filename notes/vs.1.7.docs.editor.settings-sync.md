...
![Turn on Sync command](/assets/turn-on-sync-lfxla1j2qs3j.png)
...
![Settings Sync configure dialog](/assets/sync-configure-6sn2pxlseuby.png)

Selecting the **Sign in & Turn on** button will ask you to choose between signing in with your Microsoft or GitHub account.

![Settings Sync configure dialog](/assets/sync-accounts-k7lxxi6smx19.png)
...
![Settings Sync Merge or Replace dialog](/assets/sync-merge-replace-h7l3yl55c167.png)
...
![Settings Sync Merges](/assets/sync-merges-view-5hps7odr6qia.png)

## Configuring synced data

Machine settings (with `machine` or `machine-overridable` [[vs.1.7.updates.v1_34.md#machinespecific-settings]]) are not synchronized by default, since their values are specific to a given machine. You can also add or remove settings you want to this list from the Settings editor or using the setting `settingsSync.ignoredSettings`.

![Settings Sync ignored settings](/assets/sync-ignored-settings-w43zdy6q5ejp.png)
...
![Settings Sync ignored settings](/assets/sync-ignored-extensions-kkagu47szzgl.png)
...
By default, the VS Code Stable and [[vs.1.7.insiders]] builds use different Settings Sync services, and therefore do not share settings. You can sync your Insiders with Stable by selecting the Stable sync service while turning on Settings Sync. This option is only available in VS Code Insiders.

![Settings Sync Switch Service](/assets/settings-sync-switch-ggvqc9s5vlsj.png)
...
![Settings Sync backup views](/assets/sync-backup-views-7pjwlx0fqjea.png)
...
![Settings Sync enable local backup views](/assets/sync-enable-local-activity-view-f551jf3h3u9g.png)
...
![Settings Sync machines views](/assets/sync-machines-view-dy15a9ytb4p5.png)
...
There is an example of using `setKeysforSync` in the [[vs.1.7.api.extension-capabilities.common-capabilities.md#data-storage]] topic.
...
Yes. Please refer to the [[vs.1.7.#syncing-stable-versus-insiders]] section for more information.
