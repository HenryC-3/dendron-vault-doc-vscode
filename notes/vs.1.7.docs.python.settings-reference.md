...
For general information about working with settings in VS Code, refer to [[vs.1.7.docs.getstarted.settings]], as well as the [[v[[vs.1.7.docs.editor.variables-reference]]r information about predefined variable support.
...
| envFile | `"${workspaceFolder}/`<br/>`.env"` | Absolute path to a file containing environment variable definitions. See [[vs.1.7.docs.python.environments.md#environment-variable-definitions-file]]. |
...
| --- | --- | --- | --- |
| extraPaths | `[[vs.1.7.docs.python.editing.md#autocomplete-and-intellisense]] |

## Formatting settings

| Setting<br/>(python.formatting.) | Default | Description | See also |
| --- | --- | --- | --- |
| provider | `"autopep8"` | Specifies the formatter to use, either "autopep8", "black", or "yapf". |[[vs.1.7.docs.python.editing.md#formatting]] |
| autopep8Path | `"autopep8"` | Path to autopep8 | [[vs.1.7.docs.python.editing.md#formatting]] |
| autopep8Args| `[[vs.1.7.docs.python.editing.md#formatting]] |
| blackPath | `"black"` | Path to black | [[vs.1.7.docs.python.editing.md#formatting]] |
| blackArgs| `[[vs.1.7.docs.python.editing.md#formatting]] |
| yapfPath | `"yapf"` | Path to yapf | [[vs.1.7.docs.python.editing.md#formatting]] |
| yapfArgs| `[[vs.1.7.docs.python.editing.md#formatting]] |

## Refactoring - Sort Imports settings

| Setting<br/>(python.sortImports.) | Default | Description | See also |
| --- | --- | --- | --- |
| path | `""` | Path to isort script | [[vs.1.7.docs.python.editing.md#sort-imports]] |
| args | `[[vs.1.7.docs.python.editing.md#sort-imports]] |
...
| --- | --- | --- | --- |
| enabled | `true` | Specifies whether to enable linting in general. | [[vs.1.7.docs.python.linting]] |
| lintOnSave | `true` | Specifies whether to lint when saving a file. | [[vs.1.7.docs.python.linting]] |
| maxNumberOfProblems | `100` | Limits the number of linting messages shown. | [[vs.1.7.docs.python.linting]] |
| ignorePatterns | `[[vs.1.7.docs.python.linting]] |

### Pylint

| Setting<br/>(python.linting.) | Default | Description | See also |
| --- | --- | --- | --- |
| pylintEnabled | `true` | Specifies whether to enable Pylint. | [[vs.1.7.docs.python.linting]] |
| pylintArgs | `[[vs.1.7.docs.python.linting]] |
| pylintPath | `"pylint"` | The path to Pylint. | [[vs.1.7.docs.python.linting]] |
| pylintCategorySeverity.convention | `"Information"` | Mapping for Pylint convention message to VS Code type. | [[vs.1.7.docs.python.linting]] |
| pylintCategorySeverity.refactor | `"Hint"` | Mapping for Pylint refactor message to VS Code type. | [[vs.1.7.docs.python.linting]] |
| pylintCategorySeverity.warning | `"Warning"` | Mapping for Pylint warning message to VS Code type. | [[vs.1.7.docs.python.linting]] |
| pylintCategorySeverity.error | `"Error"` | Mapping for Pylint error message to VS Code type. | [[vs.1.7.docs.python.linting]] |
| pylintCategorySeverity.fatal | `"Error"` | Mapping for Pylint fatal message to VS Code type. | [[vs.1.7.docs.python.linting]] |

### pycodestyle (pep8)

| Setting<br/>(python.linting.) | Default | Description | See also |
| --- | --- | --- | --- |
| pycodestyleEnabled | `false` | Specifies whether to enable pycodestyle. | [[vs.1.7.docs.python.linting]] |
| pycodestyleArgs | `[[vs.1.7.docs.python.linting]] |
| pycodestylePath | `"pycodestyle"` | The path to pycodestyle. | [[vs.1.7.docs.python.linting]] |
| pycodestyleCategorySeverity.W | `"Warning"` | Mapping for pycodestyle W message to VS Code type.| [[vs.1.7.docs.python.linting]] |
| pycodestyleCategorySeverity.E | `"Error"` | Mapping for pycodestyle E message to VS Code type.| [[vs.1.7.docs.python.linting]] |

### Flake8

| Setting<br/>(python.linting.) | Default | Description | See also |
| --- | --- | --- | --- |
| flake8Enabled | `false` | Specifies whether to enable flake8. | [[vs.1.7.docs.python.linting]] |
| flake8Args | `[[vs.1.7.docs.python.linting]] |
| flake8Path | `"flake8"` | The path to flake8. | [[vs.1.7.docs.python.linting]] |
| flake8CategorySeverity.F | `"Error"` | Mapping for flake8 F message to VS Code type.| [[vs.1.7.docs.python.linting]] |
| flake8CategorySeverity.E | `"Error"` | Mapping for flake8 E message to VS Code type.| [[vs.1.7.docs.python.linting]] |
| flake8CategorySeverity.W | `"Warning"` | Mapping for flake8 W message to VS Code type.| [[vs.1.7.docs.python.linting]] |

### mypy

| Setting<br/>(python.linting.) | Default | Description | See also |
| --- | --- | --- | --- |
| mypyEnabled | `false` | Specifies whether to enable mypy. | [[vs.1.7.docs.python.linting]] |
| mypyArgs | `[[vs.1.7.docs.python.linting]] |
| mypyPath | `"mypy"` | The path to mypy. | [[vs.1.7.docs.python.linting]] |
| mypyCategorySeverity.error | `"Error"` | Mapping for mypy error message to VS Code type. | [[vs.1.7.docs.python.linting]] |
| mypyCategorySeverity.note | `"Information"` | Mapping for mypy note message to VS Code type. | [[vs.1.7.docs.python.linting]] |

### pydocstyle

| Setting<br/>(python.linting.) | Default | Description | See also |
| --- | --- | --- | --- |
| pydocstyleEnabled | `false` | Specifies whether to enable pydocstyle. | [[vs.1.7.docs.python.linting]] |
| pydocstyleArgs | `[[vs.1.7.docs.python.linting]] |
| pydocstylePath | `"pydocstyle"` | The path to pydocstyle. | [[vs.1.7.docs.python.linting]] |

### prospector

| Setting<br/>(python.linting.) | Default | Description | See also |
| --- | --- | --- | --- |
| prospectorEnabled | `false` | Specifies whether to enable prospector. | [[vs.1.7.docs.python.linting]] |
| prospectorArgs | `[[vs.1.7.docs.python.linting]] |
| prospectorPath | `"prospector"` | The path to prospector. | [[vs.1.7.docs.python.linting]] |

### pylama

| Setting<br/>(python.linting.) | Default | Description | See also |
| --- | --- | --- | --- |
| pylamaEnabled | `false` | Specifies whether to enable pylama. | [[vs.1.7.docs.python.linting]] |
| pylamaArgs | `[[vs.1.7.docs.python.linting]] |
| pylamaPath | `"pylama"` | The path to pylama. | [[vs.1.7.docs.python.linting]] |

### bandit

| Setting<br/>(python.linting.) | Default | Description | See also |
| --- | --- | --- | --- |
| banditEnabled | `false` | Specifies whether to enable bandit. | [[vs.1.7.docs.python.linting]] |
| banditArgs | `[[vs.1.7.docs.python.linting]] |
| banditPath | `"bandit"` | The path to bandit. | [[vs.1.7.docs.python.linting]] |
...
| --- | --- | --- | --- |
| cwd | null | Specifies an optional working directory for tests. | [[vs.1.7.docs.python.testing]] |
| promptToConfigure | `true` | Specifies whether VS Code prompts to configure a test framework if potential tests are discovered. | [[vs.1.7.docs.python.testing]]  |
| debugPort | `3000` | Port number used for debugging of unittest tests. | [[vs.1.7.docs.python.testing]] |
  autoTestDiscoverOnSaveEnabled | `true` | Specifies whether to enable or disable auto run test discovery when saving a test file. | [[vs.1.7.docs.python.testing]] |

### unittest framework

| Setting<br/>(python.testing.) | Default | Description | See also |
| --- | --- | --- | --- |
| unittestEnabled | `false` | Specifies whether unittest is enabled for testing. | [[vs.1.7.docs.python.testing]]  |
| unittestArgs | `[[vs.1.7.docs.python.testing]] |

### pytest framework

| Setting<br/>(python.testing.) | Default | Description | See also |
| --- | --- | --- | --- |
| pytestEnabled | `false` | Specifies whether pytest is enabled for testing. | [[vs.1.7.docs.python.testing]] |
| pytestPath | `"pytest"` | Path to pytest. Use a full path if pytest is located outside the current environment. | [[vs.1.7.docs.python.testing]] |
| pytestArgs | `[[vs.1.7.docs.python.testing]] |
...
For additional information about predefined variables and example usages, see the [[vs.1.7.docs.editor.variables-reference]] in the general VS Code docs.
