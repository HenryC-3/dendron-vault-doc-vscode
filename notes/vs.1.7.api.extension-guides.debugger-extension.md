...
![VS Code Debug Features](/assets/debug-features-edcv88e7rmuk.png)
...
![VS Code Debug Architecture](/assets/debug-arch1-z4g1rbkubmdb.png)
...
![VS Code Debug Architecture 2](/assets/debug-arch2-052z2lvk6ccj.png)
...
You can find more information in [[vs.1.7.api.references.contribution-points#contributes.breakpoints]] and [[vs.1.7.api.references.contribution-points#contributes.debuggers]] references.
...
![Mock Debugger running](/assets/mock-debug-hbcj6nc3t4e2.gif)
...
![Debugging Extension and Server](/assets/debug-mock-session-zek51v4ritbc.png)
...
![Debugging Extension and Server](/assets/debugger-extension-server-dyqd35pfiwd2.png)
...
- Upload to the Marketplace as described in [[vs.1.7.api.working-with-extensions.publishing-extension]].
