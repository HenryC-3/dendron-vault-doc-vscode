...
![Extensions view](/assets/extensions-view-item-disabled-3vcjghjxq6pp.png)
...
![Screenshot showing button with the text "Click to Continue" highlighted to click.](/assets/localtunnel-oigny2dy8gr3.png)
...
Web extension tests are supported and can be implemented similar to regular extension tests. See the [[vs.1.7.api.working-with-extensions.testing-extension]] article to learn the basic structure of extension tests.
...
It is fine to provide less functionality when your extension is running in the web. Use [[vs.1.7.api.references.when-clause-contexts]] to control which commands, views, and tasks are available or hidden with running in a virtual workspace on the web.
