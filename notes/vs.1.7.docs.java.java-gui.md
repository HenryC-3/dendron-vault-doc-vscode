...
MetaDescription: >-
  How to develop Java GUI Applications (JavaFX, AWT, Swing) in Visual Studio
  Code
---
...
![create JavaFX project](/assets/create-javafx-eqcz4b976kia.png)
