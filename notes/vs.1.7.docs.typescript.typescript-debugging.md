...
Visual Studio Code supports TypeScript debugging through its built-in [[vs.1.7.docs.nodejs.nodejs-debugging]] and [[v[[vs.1.7.docs.nodejs.browser-debugging]]
...
For a simple example of source maps in action, see the [[vs.1.7.docs.typescript.typescript-tutorial]], which shows debugging a simple "Hello World" Node.js application using the following `tsconfig.json` and VS Code default Node.js debugging configuration.
...
![launch.json IntelliSense](/assets/launch-json-intellisense-0sm9gbhe3ylz.png)

Also see [[vs.1.7.docs.nodejs.nodejs-debugging]] for examples and further explanations.
...
TypeScript is great for writing client-side code as well as Node.js applications and you can debug client-side source code with the [[vs.1.7.docs.nodejs.browser-debugging]].
...
![client-side debug breakpoint](/assets/client-side-debug-breakpoint-3nd6skxsa2tu.png)
