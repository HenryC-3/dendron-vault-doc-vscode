...
DateApproved: 1/12/2022
MetaDescription: >-
  Develop, build, and debug a Python app in a Docker container, using Visual
  Studio Code.
---
...
- Docker Desktop and the VS Code Docker extension must be installed as described in the [[vs.1.7.docs.containers.overview.md#installation]].

### Create a Python project

If you don't have a Python project already, follow the tutorial [[vs.1.7.docs.python.python-tutorial]].

> **Note**: If you want to containerize a complete Django or Flask web app, you can use one of the following samples:
>
>- [python-sample-vscode-django-tutorial](https://github.com/microsoft/python-sample-vscode-django-tutorial/tree/tutorial), which is the result of following the [[vs.1.7.docs.python.tutorial-django]]
>
>- [python-sample-vscode-flask-tutorial](https://github.com/microsoft/python-sample-vscode-flask-tutorial/tree/tutorial), which is the result of following the [[vs.1.7.docs.python.tutorial-flask]]
...
1. Open the **Command Palette** (`kb(workbench.action.showCommands)`) and use the **Docker: Add Docker Files to Workspace...** command:
    ...
    ![Add Dockerfile to a Python project](/assets/python-add-python-qcp1dkaycllr.png)
...
1. Select the port number. We recommend selecting port 1024 or above to mitigate security concerns from [[vs.1.7.docs.containers.troubleshooting.md#running-as-a-non-root-user]].
...
1. Select either **Yes** or **No** when prompted to include [[vs.1.7.docs.containers.docker-compose]] files. If you select **Yes**, you will need to [[v[[vs.1.7.docs.containers.quickstart-python.md#django-apps]] your `wsgi.py` file in the `Dockerfile` to run the **Compose Up** command successfully. Compose is typically used when running multiple containers at once.

1. With all of this information, the Docker extension creates the following files:

    - A `Dockerfile`. To learn more about IntelliSense in this file, refer to the [[vs.1.7.docs.containers.overview]].
...
The Docker Extension helps you author Dockerfiles by using [[vs.1.7.docs.editor.intellisense]] to provide auto-completions and contextual help. To see this feature in action:

1. Open the `Dockerfile`.
2. Underneath the `EXPOSE` statement, type `kb(editor.action.triggerSuggest)` to trigger IntelliSense and scroll to `ENV`.

    ![Adding environment variable to Dockerfile](/assets/python-edit-dockerfile-ec7otrbhy9yx.png)
...
1. Navigate to **Run and Debug** and select **Docker: Python - General**, **Docker: Python - Django**, or **Docker: Python - Flask**, as appropriate.
    ...
    ![Selected Docker debug configuration](/assets/python-debug-configuration-o1cevglztep3.png)
...
The Docker extension will launch your browser to a randomly mapped port:
  ...
  ![Django website launches](/assets/python-web-launch-g3lrjz1gvebl.png)
...
1. In the **Containers** tab, right-click on your container and choose **View Logs**.
    ...
    ![Viewing the logs of a container](/assets/python-view-logs-bv8zrwvhs0r9.png)
...
- [[vs.1.7.docs.containers.docker-compose.md#python]]
- [[vs.1.7.docs.containers.debug-python]]
- [[vs.1.7.docs.containers.reference]]
- [[vs.1.7.docs.containers.quickstart-container-registries.md#push-an-image-to-a-container-registry]]
- [[vs.1.7.docs.containers.tutorial-django-push-to-registry]]
- [Deploy a containerized app to Azure App Service](https://docs.microsoft.com/azure/python/tutorial-deploy-containers-01)
- [[vs.1.7.docs.containers.docker-compose]]
