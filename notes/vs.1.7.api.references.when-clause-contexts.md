...
`editorLangId` | True when the editor's associated [[vs.1.7.docs.languages.identifiers]] matches. Example: `"editorLangId == typescript"`.
...
`resourceLangId` | True when the Explorer or editor title [[vs.1.7.docs.languages.identifiers]] matches. Example: `"resourceLangId == markdown"`
