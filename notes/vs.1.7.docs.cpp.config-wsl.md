...
MetaDescription: >-
  Configuring the C++ extension in Visual Studio Code to target g++ and GDB on
  WSL installation with Ubuntu
---
...
Visual Studio Code has support for working directly in WSL with the [Remote - WSL extension](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-wsl). We recommend this mode of [[vs.1.7.docs.remote.wsl]], where all your source code files, in addition to the compiler, are hosted on the Linux distro. For more background, see [[v[[vs.1.7.docs.remote.remote-overview]]
...
1. Open the Bash shell for WSL. If you installed an Ubuntu distro, type "Ubuntu" in the Windows search box and then click on it in the result list. For Debian, type "Debian", and so on.
   ...
   ![Ubuntu in Start Menu](/assets/start-ubuntu-zxkxk9m1r55s.png)
   ...
   ![Bash Shell](/assets/bash-ubuntu-oe3v9eeoe75l.png)
...
![File Explorer in WSL](/assets/file-explorer-wsl-fmhy9083qpo5.png)

You can also tell the remote context from the Status bar.

![Remote context in the Status bar](/assets/wsl-status-bar-wxotbx3vdjw8.png)
...
![New File title bar button](/assets/new-file-button-92r53pelbpac.png)
...
![C++ extension notification](/assets/cpp-extension-notification-gw8xdt2di7oi.png)
...
![Install in WSL button](/assets/install-in-wsl-l344nic37qou.png)
...
![File Explorer](/assets/file-explorer-helloworld-erc299jvensh.png)
...
The Activity Bar on the far left lets you open different views such as **Search**, **Source Control**, and **Run**. You'll look at the **Run** view later in this tutorial. You can find out more about the other views in the VS Code [[vs.1.7.docs.getstarted.userinterface]].
...
![Command Palette](/assets/intellisense-configurations-wsl-uwql8xsww6o6.png)
