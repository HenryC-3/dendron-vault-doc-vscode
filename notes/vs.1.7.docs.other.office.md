...
![An Office add-in is composed of a manifest.xml file and your web app.](/assets/officeaddinoverview-59h3nftehpls.png)
...
![The manifest.xml file of an Office Add-ins project in Visual Studio Code](/assets/office-add-in-manifest-9qd3udgpbaoy.png)
...
If you are using [Node.js](https://nodejs.org/) or [ASP.NET Core](https://asp.net) for server-side logic to support your Office Add-in, refer to the [[vs.1.7.docs.editor.debugging]] page to configure VS Code for debugging either of these runtimes.
...
- [[vs.1.7.docs.languages.overview]] - You can write Office Add-ins in many languages. Find out what VS Code has to offer.
- [[vs.1.7.docs.getstarted.userinterface]] - Just starting out with VS Code? This is worth reviewing.
...
Absolutely, VS Code has great support for [[vs.1.7.docs.languages.typescript]]!
