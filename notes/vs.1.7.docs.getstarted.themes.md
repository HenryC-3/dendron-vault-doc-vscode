...
MetaDescription: >-
  Changing the color theme in Visual Studio Code. You can use color themes
  provided by VS Code, the community or create your own new themes.
---
# Color Themes
...
![Preview themes from the Command Palette](/assets/themes_hero-1fo85j170akh.gif)
...
![Themes in the Command Palette](/assets/colorthemes-g370ko5ruhep.png)

The active color theme is stored in your user [[vs.1.7.docs.getstarted.settings]] (keyboard shortcut `kb(workbench.action.openSettings)`).
...
> **Tip:** By default, the theme is stored in your user settings and applies globally to all workspaces. You can also configure a workspace specific theme. To do so, set a theme in the Workspace [[vs.1.7.docs.getstarted.settings.md#workspace-settings]].

## Color Themes from the Marketplace

There are several out-of-the-box color themes in VS Code for you to try.

Many more themes have been uploaded to the VS Code [[vs.1.7.docs.editor.extension-marketplace]] by the community.  If you find one you want to use, install it and restart VS Code and the new theme will be available.
...
![Searching for themes in the Extensions view](/assets/category-themes-lp4tszb3wb8e.png)
...
You can customize your active color theme with the `workbench.colorCustomizations` and `editor.tokenColorCustomizations` user [[vs.1.7.docs.getstarted.settings]].
...
![activity bar theming](/assets/theme-activitybar-nqber2l55iye.gif)

You can use IntelliSense while setting `workbench.colorCustomizations` values or, for a list of all customizable colors, see the [[vs.1.7.api.references.theme-color]].
...
To tune the editor's syntax highlighting colors, use `editor.tokenColorCustomizations` in your user [[vs.1.7.docs.getstarted.settings]] `settings.json` file:

![Token Color Customization](/assets/token_color_customization-fnzda99osr60.png)
...
![Advanced Token Color Customization](/assets/token_color_customization_advanced-2znjx1y6fvo7.png)

>**Note**: Directly configuring TextMate rules is an advanced skill as you need to understand on how TextMate grammars work. Go to the [[vs.1.7.api.extension-guides.color-theme]] for more information.
...
![without semantic highlighting](/assets/no-semantic-highlighting-lktsi88kb42u.png)

The "Tomorrow Night Blue" color theme with semantic highlighting:

![with semantic highlighting](/assets/with-semantic-highlighting-ryxv0zc47ova.png)
...
![scope inspector](/assets/semantic-highlighting-scope-inspector-eko511mj91st.png)
...
More information on semantic tokens and styling rule syntax can be found in the [[vs.1.7.api.language-extensions.semantic-highlight-guide]].
...
VS Code's Yeoman [[vs.1.7.api.get-started.your-first-extension]] will help you generate the rest of the extension.

See the [[vs.1.7.api.extension-guides.color-theme.md#create-a-new-color-theme]] topic in our Extension API section to learn more.
...
![built-in themes](/assets/built-in-themes-mvlwxo3vrj54.png)

You can disable a built-in theme extension as you would any other VS Code [[vs.1.7.docs.editor.extension-marketplace]] with the **Disable** command on the gear context menu.

![disable theme](/assets/disable-theme-7oagq8gpc43g.png)
...
![file icon theme dropdown](/assets/file-icon-theme-dropdown-essk32ssbrdu.png)
...
The active File Icon theme is persisted in your user [[vs.1.7.docs.getstarted.settings]] (keyboard shortcut `kb(workbench.action.openSettings)`).
...
You can create your own File Icon Theme from icons (preferably SVG), see the [[vs.1.7.api.extension-guides.file-icon-theme]] topic in our Extension API section for details.
...
* [[vs.1.7.docs.editor.userdefinedsnippets]] - Add additional snippets to your favorite language.
* [[vs.1.7.api]] - Learn about other ways to extend VS Code.
* [[vs.1.7.api.extension-guides.color-theme]] - Color Theme extension API.
* [[vs.1.7.api.extension-guides.file-icon-theme]] - File Icon Theme extension API.
