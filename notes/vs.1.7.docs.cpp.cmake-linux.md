...
1. [CMake Tools extension for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-vscode.cmake-tools). Install the CMake Tools extension by searching for 'CMake tools' in the **Extensions** view (`kb(workbench.view.extensions)`).
    ...
    ![CMake tools extension](/assets/cmake-extension-fbl2t2ov6k4s.png)
...
![Create CMake quickstart](/assets/cmake-quickstart-command-palette-j1r31pk1weho.png)
...
![Choose project type](/assets/cmake-choose-type-rs6v8gqqmbm7.png)
...
![Project contents](/assets/cmake-project-contents-9icyyrjx5lvz.png)
...
1. Select the compiler you want to use. For example, depending on the compilers you have installed, you might see something like:
    ...
    ![Select the kit](/assets/cmake-selectkit-nf9cg06rxyon.png)
...
![Selected kit in Status bar](/assets/cmake-kit-statusbar-ao275ab87b3z.png)
...
![Select variant](/assets/cmake-select-variant-x96elmqjjxdo.png)

Select **Debug** to include debug information with your build.

![Select debug variant type](/assets/cmake-variant-type-c0wrsjyrkv4k.png)
...
![Build](/assets/cmake-build-bx2l9b1oovsb.png)
...
![Debug](/assets/cmake-debug-iml2rnv9s6hn.png)
