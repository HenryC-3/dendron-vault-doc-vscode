...
Sometimes you may want to customize the configuration to run your test cases. To achieve this, you can add the configuration into your workspace [[vs.1.7.docs.getstarted.settings]] under the section: `java.test.config`.

![Customize test configurations](/assets/configuration-qbeixmzmy9v3.png)
...
![Testing commands in the Command Palette](/assets/command_palette-8htdjburv4ho.png)
...
![Testing settings in the Settings editor](/assets/settings-s7k65egb8m6n.png)
