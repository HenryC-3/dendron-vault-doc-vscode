...
MetaDescription: >-
  You can open and work on multiple project folders in Visual Studio Code with
...
![multi-root hero](/assets/hero-9rf2vwt7kk9i.png)

>**Note**: If you'd like to learn more about the VS Code "workspace" concept, you can review [[vs.1.7.docs.editor.workspaces]] Unless you are explicitly creating a multi-root workspace, a "workspace" is just your project's single root folder.
...
![Add Root Folder](/assets/add-root-folder-ua4twk6henk1.png)
...
![Remove Root Folder](/assets/explorer-context-tshhbqibckr7.png)
...
![save workspace dialog](/assets/save-workspace-uu54c3z1pv2w.png)
...
![open recent workspace list](/assets/open-recent-6ynhtt2iq7yd.png)
...
![named folders](/assets/named-folders-7twitt3loks5.png)
...
![tabbed headers](/assets/tabbed-headers-vwva2qqy337v.png)

If you'd always like to see the folder displayed in the tabbed header, you can use the `workbench.editor.labelFormat` [[vs.1.7.docs.getstarted.settings]] "medium" or "long" values to show the folder or full paths.
...
![quick pick has folder name](/assets/quick-open-list-1v72l919htsq.png)

If you are using an [[vs.1.7.docs.getstarted.themes.md#file-icon-themes]] and the active theme supports it, you will see a special Workspace icon.

Below you can see the Workspace icons from the built-in **Minimal (Visual Studio Code)** file icon theme:

![custom workspace icon](/assets/workspace-icon-f5mqfvz963cl.png)

### Search

VS Code features like global search work across all folders and group the search results by folder.

![multi-root search results](/assets/search-q10uqk8dgnek.png)
...
![settings dropdown](/assets/settings-dropdown-qd7h0r4af5zx.png)
...
![unsupported setting information](/assets/unsupported-setting-info-q105e1dsictz.png)
...
![debugging dropdown](/assets/debugging-dropdown-qbrgkhxd821t.png)
...
![Workspace Settings](/assets/workspace-settings-p6rggolr38ha.png)
...
![Add Config](/assets/add-config-bnxshrfmljon.png)
...
![tasks dropdown](/assets/tasks-dropdown-sx1hsp33h9ee.png)
...
![multiple scm providers](/assets/multiple-scm-providers-rfftchdd1o5s.png)
...
* [[vs.1.7.docs.editor.workspaces]] - More about single-folder and multi-root workspaces.
* [[vs.1.7.docs.editor.debugging]] - Learn how to set up debugging for your application.
* [[vs.1.7.docs.editor.tasks]] - Tasks let you run external tools like compilers within VS Code.
