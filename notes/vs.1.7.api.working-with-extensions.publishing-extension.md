...
- The badges provided in the `package.json` may not be SVGs unless they are from [[vs.1.7.api.references.extension-manifest#approved-badges]].
- Image URLs in `README.md` and `CHANGELOG.md` need to resolve to `https` URLs.
- Images in `README.md` and `CHANGELOG.md` may not be SVGs unless they are from [[vs.1.7.api.references.extension-manifest#approved-badges]].
...
![Personal settings menu](/assets/token1-0xi8qfq4kujz.png)
...
![Create personal access token](/assets/token2-n52xyg3e1j5q.png)
...
A **publisher** is an identity who can publish extensions to the Visual Studio Code Marketplace. Every extension needs to include a `publisher` name in its [[vs.1.7.api.references.extension-manifest]].
...
![Marketplace extension report](/assets/extension-report-b7lsl4a8o8xi.png)
...
This will modify the extension's `package.json` [[vs.1.7.api.references.extension-manifest#fields]] attribute before publishing the extension.
...
![Rust extension shown as deprecated in extension search](/assets/deprecated-i9jqi9ngpm79.png)
...
![Deprecated extensions showing a migrate button](/assets/deprecated-migrate-5psl99bzotca.png)
...
Also see [[vs.1.7.api.references.extension-manifest#marketplace-presentation-tips]].
...
![Sponsor button in extension details page](/assets/sponsor-gx2bmu2c3283.png)
...
![GitHub PR extension pre-release version in the extensions view](/assets/pre-release-j2nl5qjxd194.png)
...
- [[vs.1.7.docs.editor.extension-marketplace]] - Learn more about VS Code's public Extension Marketplace.
- [[vs.1.7.api.working-with-extensions.testing-extension]] - Add tests to your extension project to ensure high quality.
- [[vs.1.7.api.working-with-extensions.bundling-extension]] - Improve load times by bundling your extension files with webpack.
...
Yes, see the [[vs.1.7.api.working-with-extensions.continuous-integration#automated-publishing]] section of the [[vs.1.7.api.working-with-extensions.continuous-integration]] topic to learn how to configure Azure DevOps, GitHub Actions, and Travis CI to automatically publish your extension to the Marketplace.
