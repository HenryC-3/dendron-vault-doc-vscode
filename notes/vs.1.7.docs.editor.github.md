...
If you're new to source control or want to learn more about VS Code's basic Git support, you can start with the [[vs.1.7.docs.editor.versioncontrol]] topic.
...
![Extension Sign In](/assets/extension-signin-v5luo8neaii0.png)
...
![Clone Repository button in the Source Control view](/assets/git-clone-button-gngvllyggey6.png)

From the GitHub repository dropdown you can filter and pick the repository you want to clone locally.

![GitHub repository dropdown filtered on microsoft/vscode](/assets/github-repo-dropdown-g5586rinmo3g.png)
...
![Authentication Prompt](/assets/auth-prompt-j0bdd19am026.png)
...
>**Note**: If you'd like to work on a repository without cloning the contents to your local machine, you can install the [GitHub Repositories](https://marketplace.visualstudio.com/items?itemName=github.remotehub) extension to browse and edit directly on GitHub. You can learn more below in the [[vs.1.7.docs.editor.github.md#github-repositories-extension]] section.
...
![User and Issue suggestions](/assets/user-issue-suggest-g7eku1p2ruhf.gif)

The issues that appear in the suggestion can be configured with the **GitHub Issues: Queries** (`githubIssues.queries`) [[vs.1.7.docs.getstarted.settings]]. The queries use the [GitHub search syntax](https://help.github.com/articles/understanding-the-search-syntax).

You can also configure which files show these suggestions using the settings **GitHub Issues: Ignore Completion Trigger** (`githubIssues.ignoreCompletionTrigger`) and **GitHub Issues: Ignore User Completion Trigger** (`githubIssues.ignoreUserCompletionTrigger`). These settings take an array of [[vs.1.7.docs.languages.identifiers]] to specify the file types.
...
![Pull Request View](/assets/pull-request-view-acfzlxhto7lb.png)
...
![Create Pull Request button in the Pull Request view](/assets/create-pull-request-button-uyosxxuhjgiz.png)
...
![Create Pull Request view](/assets/create-pull-request-view-vzzr45clrxqx.png)
...
![Pull Request Description editor](/assets/pull-request-description-editor-obwntk7x006g.png)
...
![Changes in Pull Request view](/assets/changes-view-ml1zspadoho8.png)
...
![Create Issue from TODO](/assets/issue-from-todo-q2hi6ztrzc3c.gif)
...
![Issue view with hover](/assets/issues-view-qq0k80jtvv5q.png)
...
![Work on Issue](/assets/working-on-issue-4szv3cdubml7.png)
...
![Issue Status bar actions](/assets/issue-status-bar-actions-q89fkdoh3osh.png)
...
![GitHub Repositories extension](/assets/github-repositories-extension-djav4f91vt4w.png)
...
![Remote indicator in the Status bar](/assets/remote-indicator-q5jf4tdefo19.png)
...
![GitHub Repository extension open repository dropdown](/assets/open-github-repository-dropdown-ftigu2kjxhi1.png)
...
![Branch indicator on the Status bar](/assets/branch-indicator-status-bar-lfsiq1bxdgyq.png)
...
![Remote Explorer view](/assets/github-remote-explorer-ra9lcwymq9h4.png)
...
![Create a Pull Request button in the Source Control view](/assets/github-repositories-create-pull-request-uqxerq6kkdwv.png)

Once you have created a Pull Request, you can use the [GitHub Pull Request and Issues](https://marketplace.visualstudio.com/items?itemName=GitHub.vscode-pull-request-github) extension to review, edit, and merge your PR as described [[vs.1.7.docs.editor.github.md#pull-requests]] in this topic.
...
![Remote indicator hover with features are not available link](/assets/features-not-available-hover-jfsrazpkb332.png)
...
Sometimes you'll want to switch to working on a repository in a development environment with support for a local file system and full language and development tooling. The GitHub Repositories extension makes it easy for you to clone the repository locally or into a Docker container (if you have [Docker](https://docker.com/) and the Microsoft [Docker extension](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-docker) installed) with the **GitHub Repositories: Continue Working on...** command available from the Command Palette (`kb(workbench.action.showCommands)`) or by clicking on the Remote indicator in the Status bar.

![Continue Working on command in Remote dropdown](/assets/continue-working-dx6ndiqqzhaj.png)

If you are using the [[vs.1.7.docs.remote.codespaces.md#browserbased-editor]], the **"Continue Working On..."** command has the options to open the repository locally or within a cloud-hosted environment in [GitHub Codespaces](https://github.com/features/codespaces).

![Continue Working On from web-based editor](/assets/codespaces-continue-9gy4b2ek7w75.png)
