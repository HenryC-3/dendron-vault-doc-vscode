...
MetaDescription: >-
  Configuring the C++ extension in Visual Studio Code to target g++ and gdb on a
  Mingw-w64 installation
---
# Using GCC with MinGW

In this tutorial, you configure Visual Studio Code to use the GCC C++ compiler (g++) and GDB debugger from [[vs.1.7.http:..mingw-w64.org]] to create programs that run on Windows.
...
![New File title bar button](/assets/new-file-button-dn7k5um6f4ql.png)
...
![File Explorer](/assets/file-explorer-mingw-lml2q3g3hroj.png)
...
3. Choose **C/C++: g++.exe build and debug active file** from the list of detected compilers on your system.
   ...
   ![C++ debug configuration dropdown](/assets/select-gcc-compiler-qe9psl1xv9z2.png)
...
1. If you like, you can keep pressing **Step over** until all the words in the vector have been printed to the console. But if you are curious, try pressing the **Step Into** button to step through source code in the C++ standard library!
   ...
   ![Debug output in terminal](/assets/mingw-debug-output-f3n7nz0rb863.png)
...
![Command Palette](/assets/intellisense-configurations-mingw-q579zu25ri2d.png)
