...
You can extend the VS Code editor itself through [[vs.1.7.docs.editor.extension-marketplace]]. The VS Code community has built hundreds of useful extensions available on the VS Code [Marketplace](https://marketplace.visualstudio.com/VSCode).
...
* [[vs.1.7.docs.languages.overview]] - VS Code supports many programming languages out-of-the-box as well as many more through community created extensions.
