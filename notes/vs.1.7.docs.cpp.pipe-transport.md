...
Pipe transport allows communication through a pipe program to a remote shell. For example, `ssh` on Linux. With the introduction of [[vs.1.7.docs.remote.remote-overview]] pipe transport is relevant primarily for IoT scenarios.
