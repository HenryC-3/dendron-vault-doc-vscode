...
![vscode.dev connected to the VS Code Server](/assets/server-connected-a995suvakb05.png)

### A preview of a larger journey

The VS Code Server is currently a private preview. In this early preview, the `code-server` CLI is distinct from the `code` CLI [[vs.1.7.docs.editor.command-line.md#launching-from-command-line]] to launch the desktop VS Code, to install extensions, and more (run `code -h` from the terminal to review the possible commands).
...
![The VS Code Server architecture](/assets/server-arch-xq5jzc6gx6c6.png)
...
1. Install the VS Code Server on your remote machine. You can install and host it in a machine on-premises or in the cloud, as long as it meets the necessary [[vs.1.7.docs.remote.linux]].
...
![The VS Code Server help commands](/assets/server-help-ursj0ou4a8zt.png)
...
![VS Code remote indicator connected to a remote server](/assets/remote-indicator-server-azjyy7rki2gn.png)
...
![VS Code Command Palette with remote servers listed](/assets/remote-servers-ab6dmh8yhray.png)
...
Pure UI extensions are not supported when using a web-based instance of VS Code, which you can learn more about in the extension authors [[vs.1.7.api.advanced-topics.remote-extensions.md#architecture-and-extension-kinds]] guide.

### Are there browser limitations?

While working in the browser, there are certain limitations and configuration steps to consider. You can read more about this in the [[vs.1.7.docs.editor.vscode-web.md#additional-browser-setup]] documentation.
