...
MetaDescription: >-
  The Visual Studio Code editor has great support for writing and debugging
  Node.js applications. This tutorial takes you from Hello World to a full
...
![File Explorer New File](/assets/toolbar-new-file-xu101smqm37f.png)

and name the file `app.js`:

![File Explorer app.js](/assets/app-js-file-created-c8f2jr98dw8o.png)

By using the `.js` file extension, VS Code interprets this file as JavaScript and will evaluate the contents with the JavaScript language service. Refer to the VS Code [[vs.1.7.docs.languages.javascript]] topic to learn more about JavaScript support.
...
Note that when you typed `console.` [[vs.1.7.docs.editor.intellisense]] on the `console` object was automatically presented to you.

![console IntelliSense](/assets/consoleintellisense-elciaghmze6e.png)
...
![string IntelliSense](/assets/stringintellisense-7h2htk4ab3we.png)
...
VS Code has an [[vs.1.7.docs.terminal.basics]] which you can use to run shell commands. You can run Node.js directly from there and avoid switching out of VS Code while running command-line tools.
...
![integrated terminal](/assets/integrated-terminal-3kpgtdhy72hv.png)
...
![app.js breakpoint set](/assets/app-js-breakpoint-set-w4xlhh8qs0n5.png)

To start debugging, select the **Run and Debug** view in the Activity Bar:

![Run icon](/assets/debugicon-b1h0xadtzkyd.png)
...
![hello world debugging](/assets/hello-world-debugging-7w0k6wypz8u9.png)
...
The Node.js web server will start and you can browse to [[vs.1.7.http:..localhost:3000]] to see the running application.

![Your first Node Express App](/assets/express-4vgm8lf077q7.png)
...
![http IntelliSense](/assets/intellisense-612b4gz2xbij.png)
...
![Express.Router IntelliSense](/assets/moduleintellisense-di769yrwz69i.png)
...
![Debug session](/assets/debugsession-53m4k5nnr40y.png)

## Deploy your application

If you'd like to learn how to deploy your web application, check out the [[vs.1.7.docs.azure.deployment]] tutorials where we show how to run your website in Azure.
...
* [[vs.1.7.docs.getstarted.settings]] - Learn how to customize VS Code for how you like to work.
...
* [[vs.1.7.docs.nodejs.nodejs-debugging]] - Learn more about VS Code's built-in Node.js debugging.
* [[vs.1.7.docs.nodejs.debugging-recipes]] - Examples for scenarios like client-side and container debugging.
