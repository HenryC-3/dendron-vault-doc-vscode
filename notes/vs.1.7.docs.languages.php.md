...
MetaDescription: >-
  Learn about Visual Studio Code editor features (syntax highlighting, snippets,
  linting) and extensions for PHP.
---
# PHP in Visual Studio Code

Visual Studio Code is a great editor for PHP development. You get features like syntax highlighting and bracket matching, IntelliSense (code completion), and snippets out of the box and you can add more functionality through community-created VS Code [[vs.1.7.docs.editor.extension-marketplace]].
...
There are three [[vs.1.7.docs.getstarted.settings]] to control the PHP linter:
...
![show PHP settings](/assets/php-settings-uqpz9c0a1pu3.png)
...
![PHP Snippets](/assets/php-snippets-yuzqc9ts426t.png)
...
![Searching for PHP in the Extensions view](/assets/category-php-mhjnst3u0b78.png)
...
* [[vs.1.7.docs.editor.extension-marketplace]] - Browse the extensions others have shared
* [[vs.1.7.docs.editor.debugging]] - Learn more about VS Code debugging
