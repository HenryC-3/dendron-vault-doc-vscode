...
Portable mode is supported on the ZIP download for Windows, and the TAR.GZ download for Linux, as well as the regular Application download for macOS. See the [[vs.1.7.download]] to find the correct `.zip / .tar.gz` file for your platform.
...
1. [[vs.1.7.download]] the VS Code ZIP distribution for your platform.
