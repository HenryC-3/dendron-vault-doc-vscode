---
id: 1nna1x9chgx96iksz96qeq1
title: Faq Cpp
desc: ''
updated: 1660824078442
created: 1660824078442
isDir: false
Order: 14
Area: cpp
TOCTitle: FAQ
...
See [[vs.1.7.docs.cpp.launch-json-reference]] for more in-depth documentation on how to configure the debugger.
...
If you are experiencing a problem with the extension that we can't diagnose based on information in your issue report, we might ask you to enable logging and send us your logs. See [[vs.1.7.docs.cpp.enable-logging-cpp]] for how to get C/C++ extension logs.
