...
[[vs.1.7.api.language-extensions.language-server-extension-guide]], you can write language servers to support any programming language. However, it involves more effort to enable such support for embedded languages.
...
This guide focuses on implementing language features for embedded languages. If you are interested in providing syntax highlighting for embedded languages, you can find information in the [[vs.1.7.api.language-extensions.syntax-highlight-guide#embedded-languages]].
...
![sample](/assets/embedded-lsp-sample-nlxoamkwa5sh.gif)
...
A **language service** is a library that implements [[vs.1.7.api.language-extensions.programmatic-language-features]] for a single language. A **language server** can embed language services to handle embedded languages.
...
>**Note**: This sample assumes knowledge of the [[vs.1.7.api.language-extensions.programmatic-language-features]] and the [[vs.1.7.api.language-extensions.language-server-extension-guide]]. The code builds on top of [lsp-sample](https://github.com/microsoft/vscode-extension-samples/tree/main/lsp-sample).
