...
MetaDescription: >-
  ...
  snippets, linting) for Java.
---
# Java in Visual Studio Code

Support for Java in Visual Studio Code is provided through a wide range of [[vs.1.7.docs.java.extensions]]. Combined with the power of core VS Code, these extensions give you a lightweight and performant code editor that also supports many of the most common Java development techniques.
...
> [[vs.1.7.download]] - If you haven't downloaded VS Code yet, quickly install for your platform (Windows, macOS, Linux).
...
**NOTE:** If you are using VS Code on Windows and want to take advantage of the Windows Subsystem for Linux, see [[vs.1.7.docs.remote.wsl]].
...
> **Note**: If you have multiple JDKs installed and need to use a specific JDK version for your projects, see [[vs.1.7.docs.java.java-project.md#configure-runtime-for-projects]]. To enable Java preview features, see [[vs.1.7.docs.java.java-faq.md#how-can-i-use-visual-studio-code-with-new-java-versions]].
...
A "multi-root workspace" can refer to multiple folders (directories) from disparate parts of the file system and VS Code displays the contents of the folder(s) of the workspace together in the [[vs.1.7.docs.getstarted.userinterface.md#basic-layout]]. To learn more, see [[vs.1.7.docs.editor.multi-root-workspaces]].
...
Visual Studio Code also supports working with standalone Java files outside of a Java project, described in the [[vs.1.7.docs.java.java-tutorial]] tutorial.
...
More details about Java project support can be found in [[vs.1.7.docs.java.java-project]] and [[v[[vs.1.7.docs.java.java-build]]
...
Although it's lightweight, the Java debugger supports advanced features such as expression evaluation, conditional breakpoints, and [[vs.1.7.docs.java.java-debugging.md#hot-code-replace]]. For more debugging-related information, visit [[vs.1.7.docs.java.java-debugging]].
...
For more about testing, read [[vs.1.7.docs.java.java-testing]].
...
See [[vs.1.7.docs.java.java-tomcat-jetty]] to learn more about support for Tomcat and Jetty, as well as other application servers with VS Code.
...
See [[vs.1.7.docs.java.java-spring-boot]] to learn more about Spring Boot support in VS Code, and also [[v[[vs.1.7.docs.java.java-webapp]] [[vs.1[[vs.1.7.docs.java.java-spring-apps]]arn more about deploying Spring apps to Azure from VS Code.

## Next steps

Learn more about Java in VS Code:

* [[vs.1.7.docs.java.java-tutorial]]
* [[vs.1.7.docs.java.java-editing]]
* [[vs.1.7.docs.java.java-debugging]]
* [[vs.1.7.docs.java.java-testing]]
* [[vs.1.7.docs.java.java-project]]
* [[vs.1.7.docs.java.java-spring-boot]]
* [[vs.1.7.docs.java.java-tomcat-jetty]]
* [[vs.1.7.docs.java.java-on-azure]]
