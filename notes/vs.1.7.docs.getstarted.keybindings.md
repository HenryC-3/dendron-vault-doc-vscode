...
MetaDescription: >-
  Here you will find the complete list of key bindings for Visual Studio Code
...
![Keyboard Shortcuts](/assets/keyboard-shortcuts-0y1e328fw9ju.gif)
...
For doing more advanced keyboard shortcut customization, read [[vs.1.7.docs.getstarted.keybindings.md#advanced-customization]].
...
![show keybinding conflicts menu](/assets/show-conflicts-menu-b9heipl72fva.png)
...
![show keybinding conflicts result](/assets/show-conflicts-result-ysldkn81vnd7.png)
...
![Default Keyboard Shortcuts](/assets/user-keyboard-shortcuts-uy67zdhr2y69.png)
...
* This will open your `keybindings.json` file where you can overwrite the [[vs.1.7.docs.getstarted.keybindings.md#default-keyboard-shortcuts]].

![Open Keyboard Shortcuts JSON button](/assets/open-keyboard-shortcuts-json-9ihqqx0p5v2j.png)
...
For more information on commands that take arguments, refer to [[vs.1.7.api.references.commands]].
...
![render key binding](/assets/render-key-binding-7ulhvipasdcs.png)
...
![keybindings.json guidance](/assets/keybindings-json-ymydov31269m.png)
...
![key binding widget](/assets/key-binding-widget-w60wrcjyvhme.png)
...
![Start Debugging when clause in the Keyboard Shorts editor](/assets/start-debugging-when-clause-seibjywkf85a.png)
...
You can find the full list of when clause conditional operators in the [[vs.1.7.api.references.when-clause-contexts.md#conditional-operators]] reference.

### Available contexts

You can find some of the available `when` clause contexts in the [[vs.1.7.api.references.when-clause-contexts]].
...
The `editor.action.codeAction` command lets you configure keybindings for specific [[vs.1.7.docs.editor.refactoring]] (Code Actions). For example, the keybinding below triggers the **Extract function** refactoring Code Actions:
...
This is covered in depth in the [[vs.1.7.docs.editor.refactoring.md#keybindings-for-code-actions]] topic where you can learn about different kinds of Code Actions and how to prioritize them in the case of multiple possible refactorings.
...
![Default Keyboard Shortcuts](/assets/default-keyboard-shortcuts-sb5em2uy1q0e.png)
...
* [[vs.1.7.docs.languages.overview]] - Our Good, Better, Best language grid to see what you can expect
* [[vs.1.7.docs.editor.debugging]] - This is where VS Code really shines
* [[vs.1.7.docs.nodejs.nodejs-tutorial]] - End to end Node.js scenario with a sample app
...
![Key bindings quick outline](/assets/filter-on-keys-91pwn5nmjsu1.png)
