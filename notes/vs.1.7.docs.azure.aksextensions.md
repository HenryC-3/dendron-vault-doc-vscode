...
![Install Azure Kubernetes Services](/assets/install-aks-extension-jx8baxagtotd.png)
...
![Sign in to your Azure Account](/assets/sign-in-b3bwn9rz5cgy.png)
...
![Cloud explorer extension Run AKS Diagnostics menu](/assets/right-click-menu-m8tq76qcq1pi.png)

Start a GitHub workflow:

![Cloud explorer extension Create GitHub Workflow menu](/assets/right-click-menu-workflow-n2ub5ktoqdxw.png)
...
![AKS Diagnostics Webview](/assets/aks-diagnostics-webview-gmi3y5zetuar.png)
...
![AKS Periscope Webview](/assets/aks-periscope-webview-6bdpqbn3fa8m.png)
...
![Azure Service Operator Webview](/assets/azure-service-operator-screenshot-629uy42li0f2.png)
...
![Create Cluster From Azure Portal command on an AKS subscription](/assets/right-click-subscription-90pinax9y9sw.png)
...
![Start or Stop Cluster from properties webview](/assets/aks-startstop-cluster-2syowvmnr700.png)
