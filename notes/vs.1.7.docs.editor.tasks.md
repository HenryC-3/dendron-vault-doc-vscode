...
![VS Code can talk to a variety of external tools](/assets/tasks_hero-5mygxhp69h0w.png)
...
Extensions can also contribute tasks using a [[vs.1.7.api.extension-guides.task-provider]], and these contributed tasks can add workspace-specific configurations defined in the `tasks.json` file.
...
![TypeScript Build Task](/assets/typescript-build-fzl1nsnl09qt.png)
...
![Tasks ESLint starter](/assets/eslint-starter-grut4nlw9fvx.png)
...
![Tasks ESLint Problem Matcher Selection](/assets/eslint-problem-matcher-selection-ok71ijfle12d.png)

Executing the task produces one error, shown in the **Problems** view:

![Tasks ESLint Problem](/assets/eslint-problem-gmjd3csrwwla.png)
...
![Gulp task auto-detection](/assets/gulp-auto-detect-tikqvd7o6wj5.png)
...
![Configure Task Runner](/assets/configure-task-runner-blqoeekgqq2s.png)
...
![tasks.json IntelliSense](/assets/tasks-intellisense-zwzbaj0invnd.png)

You can also review the [[vs.1.7.docs.editor.tasks-appendix]].
...
![Tasks IntelliSense](/assets/intellisense-417qqrez7pwm.png)
...
![Tasks in Command Palette](/assets/command-palette-79xousxxeujp.png)
...
![Configure Task](/assets/configure-tasks-abmdbhacl363.png)
...
You can also create your own problem matcher, which we'll discuss [[vs.1.7.docs.editor.tasks.md#defining-a-problem-matcher]].
...
When authoring tasks configurations, it is useful to have a set of predefined common variables such as the active file (`${file}`) or workspace root folder (`${workspaceFolder}`). VS Code supports variable substitution inside strings in the `tasks.json` file and you can see a full list of predefined variables in the [[vs.1.7.docs.editor.variables-reference]].
...
![Inputs Example](/assets/run-input-example-0wi53qfo42ya.gif)

For more information about `inputs`, see the [[vs.1.7.docs.editor.variables-reference]].
...
The [[vs.1.7.docs.typescript.typescript-compiling]] includes an example that creates a task to transpile TypeScript to JavaScript and observe any related errors from within VS Code.

### Compiling Markdown to HTML

The Markdown topic provides two examples for compiling Markdown to HTML:

1. [[vs.1.7.docs.languages.markdown.md#compiling-markdown-into-html]]
2. [[vs.1.7.docs.languages.markdown.md#automating-markdown-compilation]]

### Transpiling Less and SCSS into CSS

The CSS topic provides examples of how to use Tasks to generate CSS files.

1. [[vs.1.7.docs.languages.css.md#transpiling-sass-and-less-into-css]]
2. [[vs.1.7.docs.languages.css.md#automating-sassless-compilation]]
...
![GCC Problem Matcher](/assets/problemmatcher-7jhdyc9ozfmx.png)
...
* [[vs.1.7.docs.editor.tasks-appendix]] - You can review the full `tasks.json` schema and descriptions.
...
* [[vs.1.7.docs.languages.overview]] - Learn about our supported programming languages, both shipped with VS Code and through community extensions.
...
For more on background tasks, go to [[vs.1.7.docs.editor.tasks.md#background-watching-tasks]].
