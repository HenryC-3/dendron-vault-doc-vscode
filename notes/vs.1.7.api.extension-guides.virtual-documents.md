...
![cowsay-bwd](/assets/cowsay-bwd-ijhzmbwklbxj.png)
...
If you need more flexibility and power take a look at the [[vs.1.7.api.references.vscode-api#FileSystemProvider]] API. It allows to implement a full file system, having files, folders, binary data, file-deletion, creation and more.
