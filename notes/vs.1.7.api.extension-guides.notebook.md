...
MetaDescription: >-
  Use the Notebook API to create rich Notebook experiences within Visual Studio
  Code.
---
...
![Overview of 3 components of notebooks: NotebookSerializer, NotebookController, and NotebookRenderer, and how they interact. Described textually above and in following sections.](/assets/architecture-overview-g1ty2f2ea8zo.png)
...
![Notebook showing contents of a Jupyter Notebook formatted file](/assets/ipynb-simple-provider-r23y81sc88gp.png)
...
Simple formats like Text Output, Error Output, or "simple" variants of Rich Output (HTML, Markdown, JSON, etc.) are rendered by VS Code core, whereas application specific Rich Output types are rendered by a [notebook-renderer](#notebook-renderer). An extension may optionally choose to render "simple" Rich Outputs itself, for instance to add LaTeX support to Markdown outputs.

![Diagram of the different output types described above](/assets/kernel-mvmb2ikv25q2.png)
...
![Cell with simple text output](/assets/text-output-ipblicskytdv.png)
...
![Cell with error output showing error name and message, as well as a stack trace with magenta text](/assets/error-output-rbfwmtnuar9r.png)
...
![Cell with rich output showing switching between formatted HTML, a JSON editor, and an error message showing no renderer is available (application/hello-world)](/assets/rich-output-6bqugsohkmho.gif)
...
![Notebook displaying Rust code in a built in Monaco editor](/assets/rust-output-n4thj1x0a91x.png)
...
![Cell output showing rendered HTML view of issue](/assets/static-renderer-sample-7r0wbfcjeahf.png)
...
![Diagram showing how controllers interact with renderers through the NotebookRendererScript](/assets/kernel-communication-2i8i8z5c34xf.png)
