...
MetaDescription: >-
  Java tutorial showing basic Java language support in the Visual Studio Code
  editor
---
...
For an overview of the features available for Java in VS Code, see [[vs.1.7.docs.languages.java]].
...
![Java Getting Started](/assets/getting-started-mp8iyhlcv4q6.png)
...
> **Note**: To configure JDKs for your projects, see [[vs.1.7.docs.java.java-project.md#configure-runtime-for-projects]]. To enable Java preview features, see [[vs.1.7.docs.java.java-faq.md#how-can-i-use-visual-studio-code-with-new-java-versions]].
...
VS Code will also try to figure out the correct package for the new type and fill the new file from a template. See [[vs.1.7.docs.java.java-editing.md#create-new-file]].
...
Visual Studio Code also supports more complex Java projects — see [[vs.1.7.docs.java.java-project]].
...
To learn more about editing Java, see [[vs.1.7.docs.java.java-editing]].
...
The debugger also supports advanced features such as [[vs.1.7.docs.java.java-debugging.md#hot-code-replace]] and conditional breakpoints.

For more information, see [[vs.1.7.docs.java.java-debugging]].

## More features

The editor also has many more capabilities to assist with your Java workload.

* [[vs.1.7.docs.java.java-editing]] explains how to navigate and edit Java in more details
* [[vs.1.7.docs.java.java-debugging]] illustrates all the key features of the Java Debugger
* [[vs.1.7.docs.java.java-testing]] provides comprehensive support for JUnit and TestNG framework
* [[vs.1.7.docs.java.java-project]] shows you how to use a project view and work with Maven
* [[vs.1.7.docs.java.java-spring-boot]] and [[v[[vs.1.7.docs.java.java-tomcat-jetty]]monstrate great framework support
* [[vs.1.7.docs.java.java-webapp]] shows how to work with Java Web App in VS Code
