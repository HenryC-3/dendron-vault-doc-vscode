...
You can customize your active Visual Studio Code [[vs.1.7.docs.getstarted.themes]] with the `workbench.colorCustomizations` user [[vs.1.7.docs.getstarted.settings]].
...
**Note**: If you want to use an existing color theme, see [[vs.1.7.docs.getstarted.themes]] where you'll learn how to set the active color theme through the **Preferences: Color Theme** dropdown (`kb(workbench.action.selectTheme)`).

Theme colors are available as CSS variables in [[vs.1.7.api.extension-guides.webview]], and [an extension](https://marketplace.visualstudio.com/items?itemName=connor4312.css-theme-completions) is available which provides IntelliSense for them.
...
![button control](/assets/button-pl78ew7qfptd.png)
...
![dropdown control](/assets/dropdown-4amqiglhcswq.png)
...
![input control](/assets/input-oyd3zs7txafa.png)
...
- `editorGroup.border`: Color to separate multiple editor groups from each other.
  ...
  ![editorGroup.border](/assets/editorgroup-border-bgd8qvp1dma0.gif)

- `editorGroup.dropBackground`: Background color when dragging editors around.

  ![editorGroup.dropBackground](/assets/editorgroup-dropbackground-1k5ab2h57cbv.gif)
...
- `editorGroupHeader.noTabsBackground`: Background color of the editor group title header when Tabs are disabled (set `"workbench.editor.showTabs": false`).
  ...
  ![editorGroupHeader.noTabsBackground](/assets/editorgroupheader-notabsbackground-t6gjpsvn7tfr.gif)

- `editorGroupHeader.tabsBackground`: Background color of the Tabs container.

  ![editorGroupHeader.tabsBackground](/assets/editorgroupheader-tabsbackground-rkg8k75d2tg7.gif)

- `editorGroupHeader.tabsBorder`: Border color below the editor tabs control when tabs are enabled.

  ![editorGroupHeader.tabsBorder](/assets/editorgroupheader-tabsborder-gpxxvh6i9roz.gif)
...
![selection highlight](/assets/selectionhighlight-7z6zycp89f3e.png)
...
![occurrences](/assets/occurrences-io8eb1gzdeyh.png)
...
![Find matches](/assets/findmatches-2omccww7ncoq.png)
...
![Search Editor Matches](/assets/searcheditormatches-p2wcdmimgxs5.png)
...
![Hover Highlight](/assets/hoverhighlight-ipoadgdaa2m7.png)
...
![Line Highlight](/assets/line-cme6s6zhiev7.png)
...
![Link](/assets/link-px7409ejmkjo.png)

- `editorLink.activeForeground`: Color of active links.

The range highlight is visible when selecting a search result.

![Range Highlight](/assets/rangehighlight-7q8nfhg8bptl.png)
...
![CodeLens](/assets/codelens-cl05f4fl8ixs.png)
...
![Bracket colors](/assets/bracket-colors-m9ldx95o1mj4.png)
...
![Peek view](/assets/peek-view-qyuc76y7ghzy.png)
...
![Merge ranges](/assets/merge-ranges-b71lw70wc4p8.png)
...
![Notification Toasts](/assets/notification-toast-bedv6rro8wxc.png)

Once opened in the Notification Center, they are displayed in a list with a header:

![Notification Center](/assets/notification-center-hj0mihkd9vi5.png)
...
![Keybinding label](/assets/keybinding-label-jg0fywerikje.png)
