...
Visual Studio Code is a powerful editing tool for Python source code. The editor includes various features to help you be productive when writing code. For more information about editing in Visual Studio Code, see [[vs.1.7.docs.editor.codebasics]] and [[v[[vs.1.7.docs.editor.editingevolved]]

In this overview, we will describe the specific editing features provided by the [Python extension](https://marketplace.visualstudio.com/items?itemName=ms-python.python), including steps on how to customize these features via user and workspace [[vs.1.7.docs.getstarted.settings]].
...
![Hello World Example for IntelliSense](/assets/hello-world-5817jpo8g2lf.gif)
...
To customize the behavior of the analysis engine, see the Python extension [[vs.1.7.docs.python.settings-reference.md#code-analysis-settings]] and [[vs.1.7.docs.python.settings-reference.md#autocomplete-settings]].

You can also customize the general behavior of autocomplete and IntelliSense, even to disable these VS Code features entirely. See [[vs.1.7.docs.editor.intellisense.md#customizing-intellisense]].

![IntelliSense and autocomplete for Python code](/assets/python-editing-42eq3v1ljmvr.gif)
...
For more on IntelliSense generally, see [[vs.1.7.docs.editor.intellisense]].
...
| Cause | Solution |
| --- | --- |
| The path to the python interpreter is incorrect | Make sure you selected a valid interpreter path by running the **Python: Select Interpreter** command (see [[vs.1.7.docs.python.environments]]). |
...
![Adding an import](/assets/quickfix-wv1u1s8810od.gif)
...
![Common package abbreviations](/assets/packageabbreviations-buhuhr8101fe.gif)
...
[[vs.1.7.docs.python.linting]] helps to prevent errors by analyzing code for common syntactical, stylistic, and functional errors and unconventional programming practices. Although there is a little overlap between formatting and linting, the two capabilities are complementary.
...
![Refactoring a variable](/assets/refactorextractvar-h5sck0sjkmvo.gif)
...
![Refactoring code into a method](/assets/refactorextractmethod-kugskugoyzjo.gif)
...
![Renaming a module](/assets/refactorrenamemodule-1nfg8y8o4pzs.gif)
...
![Sorting import statements](/assets/sortimports-ortolswbnvr5.gif)
...
- [[vs.1.7.docs.python.linting]] - Enable, configure, and apply various Python linters.
...
- [[vs.1.7.docs.editor.intellisense]] - Learn about IntelliSense features.
- [[vs.1.7.docs.datascience.jupyter-notebooks]] - Learn how to get started with Jupyter Notebooks.
