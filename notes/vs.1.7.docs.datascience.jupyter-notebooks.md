...
When getting started with Notebooks, you'll want to make sure that you are working in a trusted workspace. Harmful code can be embedded in notebooks and the [[vs.1.7.docs.editor.workspace-trust]] feature allows you to indicate which folders and their contents should allow or restrict automatic code execution.

If you attempt to open a notebook when VS Code is in an untrusted workspace running [[vs.1.7.docs.editor.workspace-trust.md#restricted-mode]], you will not be able to execute cells and rich outputs will be hidden.
...
![Blank Jupyter Notebook](/assets/native-code-cells-01-1630pzt2p5bg.png)

Next, select a kernel using the kernel picker in the top right.

![Kernel Picker](/assets/native-kernel-picker-8wpa6rmw90s3.png)
...
![Language Picker](/assets/native-language-picker-01-swxnno4jlz8d.png)
...
![Run Jupyter code cell](/assets/native-code-cells-03-7bxnbm0g4kie.png)

You can run multiple cells by selecting **Run All**, **Run All Above**, or **Run All Below**.

![Run Jupyter code cells](/assets/native-code-runs-xrt8vph8mxur.png)
...
You can export a Jupyter Notebook as a Python file (`.py`), a PDF, or an HTML file. To export, select the **Export** action on the main toolbar. You'll then be presented with a dropdown of file format options.
 ...
 ![Convert Jupyter Notebook to Python file](/assets/native-toolbar-export-pypf96r363z3.png)
...
![Simple Jupyter code cell](/assets/native-code-cells-02-gcizgy86w6s7.png)
...
![Unselected Jupyter code cell](/assets/native-code-unselected-02-vlbg48l9xt7d.png)
...
![Code cell in command mode](/assets/native-code-cells-02-gcizgy86w6s7.png)

 When you're in edit mode, the solid vertical bar is joined by a border around the cell editor.

![Code cell in edit mode](/assets/native-code-cells-04-mynjn3i555if.png)
...
![Add code cells](/assets/native-add-cells-u40zyp2si04u.png)
...
![Multiselected cells](/assets/multiselect-iey7hx3cdogf.png)
...
![Run Jupyter code cell](/assets/native-code-run-t8khgyf480se.png)
...
![Run multiple code cells](/assets/native-code-runs-xrt8vph8mxur.png)
...
![Move a code cell](/assets/code-move-dvkxlpuayzg9.png)
...
![Delete a code cell](/assets/native-code-delete-ae23tjib7plr.png)
...
![Change language](/assets/native-language-picker-01-swxnno4jlz8d.png)
...
![Raw Markdown displayed in code cell](/assets/native-markdown-not-rendered-nqam46papfq3.png)
...
![How to render Markdown](/assets/native-markdown-htr-47eivam0ttas.png)

![Rendered Markdown displayed in code cell](/assets/native-markdown-rendered-s5a4vp4cjhm5.png)
...
![Notebook Toolbar](/assets/notebook-toolbar-074ahmlwqfoh.png)
...
![Line numbers enabled in code cell](/assets/cell-toggle-line-num-amrt2hs4o5k9.png)

To toggle line numbering for the entire notebook, use `kbstyle(Shift+L)` when in command mode on any cell.

![Line numbers enabled for notebook](/assets/notebook-toggle-line-num-emxvm7loeur0.png)

## Table of Contents

To navigate through your notebook, open the File Explorer in the Activity bar. Then open the **Outline** tab in the Side bar.

![Table of contents](/assets/table-of-contents-bzf3qb1lfwl0.png)
...
![IntelliSense support](/assets/intellisense-63ut1qgqqaz3.png)
...
![Variable Explorer](/assets/variable-explorer-01-79o9sqzovzs3.png)

![Variable Explorer](/assets/variable-explorer-02-ylz5d75zynvb.png)
...
![Data Viewer](/assets/data-viewer-dybk2h3p416g.png)
...
![Data Viewer](/assets/filter-default-a2fl97gn8o1j.png)

If you want to find an exact match, prefix your filter with '=':

![Data Viewer](/assets/filter-exact-r1t0zdwvb7mg.png)
...
![Custom notebook diffing](/assets/notebook-diffing-2b31iy8fnqea.png)

To learn more about Git integration within VS Code, visit [[vs.1.7.docs.editor.versioncontrol]].
...
![Run by line button](/assets/run-by-line-l4wdc6oxfzmb.png)
...
![Debug cell button](/assets/debug-cell-v2lsjzr5vxl4.png)
...
1. Select the **Jupyter Server: local** button in the global Status bar or run the **Jupyter: Specify local or remote Jupyter server for connections** command from the Command Palette (`kb(workbench.action.showCommands)`).
   ...
   ![Specify remote Jupyter server](/assets/specify-remote-d9ggdfzfkpg9.png)

1. When prompted to **Pick how to connect to Jupyter**, select **Existing: Specify the URI of an existing server**.

   ![Choose to connect to an existing server](/assets/connect-to-existing-ylgfra1dhcbg.png)
...
1. When prompted to **Enter the URI of a Jupyter server**, provide the server's URI (hostname) with the authentication token included with a `?token=` URL parameter. (If you start the server in the VS Code terminal with an authentication token enabled, the URL with the token typically appears in the terminal output from where you can copy it.) Alternatively, you can specify a username and password after providing the URI.
   ...
   ![Prompt to supply a Jupyter server URI](/assets/enter-url-auth-token-hpdmghdvm6s7.png)
