...
![create new file](/assets/create-new-file-cjrxfkv7cfb1.png)
...
![compiled hello world](/assets/compiled-hello-world-sg6w6ej5udaj.png)

If you have Node.js installed, you can run `node helloworld.js`.

![run hello world](/assets/run-hello-world-pyi6u37r6erv.png)
...
![IntelliSense](/assets/intellisense-o80ld8i8f6k5.png)

When you select a method, you then get parameter help and can always get hover information.

![parameter help](/assets/parameter-help-8ha0c6aaccko.png)
...
Add a simple `tsconfig.json` that set the options to compile to ES5 and use **CommonJS** [[vs.1.7.http:..www.commonjs.org.specs.modules.1.0]].
...
![tsconfig.json IntelliSense](/assets/tsconfig-intellisense-6xxqvljikut8.png)
...
See [[vs.1.7.docs.typescript.typescript-compiling]] to learn about other features of the TypeScript language service and how to use tasks to run your builds directly from VS Code.
...
![incorrect type error](/assets/incorrect-type-error-nxu24n2w0lqb.png)
...
![unreachable code detected](/assets/unreachable-code-detected-f0xdnp890p4t.png)
...
![debug console output](/assets/debug-console-cy5udfbx08o4.png)
...
![debug breakpoint](/assets/debug-breakpoint-2x4ov2mu5ppg.png)

See [[vs.1.7.docs.typescript.typescript-debugging]] to learn more about VS Code's built-in debugging support for TypeScript and how you can configure the debugger for your project scenarios.
...
* [[vs.1.7.docs.typescript.typescript-compiling]] - Use VS Code's powerful task system for compiling TypeScript.
