...
>**Note**: More information about how to get started can be found at [[vs.1.7.docs.java.java-tutorial]] tutorial.
...
* To deploy your web app, see [[vs.1.7.docs.java.java-webapp]].
* To containerize a web app and deploy as a Docker container, check out [[vs.1.7.docs.containers.overview]].
* To learn more about Java debugging features, see [[vs.1.7.docs.java.java-debugging]].
