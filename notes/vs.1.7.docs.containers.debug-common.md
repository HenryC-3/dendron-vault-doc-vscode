...
The Docker extension currently supports debugging [[vs.1.7.#nodejs]], [[vs.1.7.#python]], and [[vs.1.7.#net]] applications within Docker containers.
...
More information about debugging Node.js applications within Docker containers can be found at [[vs.1.7.docs.containers.debug-node]].
...
More information about debugging Python applications within Docker containers can be found at [[vs.1.7.docs.containers.debug-python]].
...
More information about debugging .NET applications within Docker containers can be found in [[vs.1.7.docs.containers.debug-netcore]].
...
- [[vs.1.7.docs.containers.docker-compose.md#debug]]
