...
MetaDescription: >-
  Configure the C++ extension in Visual Studio Code to target Microsoft C++ on
  Windows.
---
...
1. Install the Microsoft Visual C++ (MSVC) compiler toolset.
   ...
   ![Build Tools for Visual Studio download](/assets/build-tools-for-vs-67wqetbz30uu.png)
   ...
   ![Cpp build tools workload](/assets/desktop_development_with_cpp-2qppisyqfdmh.png)
...
![Developer Command Prompt](/assets/developer-cmd-prompt-menu-oda6hsirm7vb.png)
...
![Checking cl.exe installation](/assets/check-cl-exe-7al9m4ar7fz4.png)
...
3. Choose **C/C++: cl.exe build and debug active file** from the list of detected compilers on your system.
   ...
   ![C++ debug configuration dropdown](/assets/select-cl-compiler-yq1ronwa8ccp.png)
...
![Command Palette](/assets/configurations-ui-ggp75pewwg0t.png)
