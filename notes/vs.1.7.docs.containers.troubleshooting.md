...
This article covers troubleshooting tips and tricks for the Visual Studio Code [Docker](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-docker) extension. See the [[vs.1.7.docs.containers.overview]] and quickstart articles for [[v[[vs.1.7.docs.containers.quickstart-node]][vs.1[[vs.1.7.docs.containers.quickstart-python]][vs.1.7.[[vs.1.7.docs.containers.quickstart-aspnet-core]]ils on setting up and working with Docker.
