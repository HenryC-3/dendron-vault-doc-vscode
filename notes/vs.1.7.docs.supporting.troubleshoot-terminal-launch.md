---
id: tzyk33br638ox5ze12u9hez
title: Troubleshoot Terminal Launch
desc: ''
...
If you are new to using the VS Code Integrated Terminal, you can learn more in the [[vs.1.7.docs.terminal.basics]] user guide. There you can read how to [[v[[vs.1.7.docs.terminal.basics.md#terminal-profiles]]e terminal, as well as review answers to [[v[[vs.1.7.docs.terminal.basics.md#common-questions]]
...
1. **Check your user settings.** Review these `terminal.integrated` [[vs.1.7.docs.getstarted.settings]] that could affect the launch:
   ...
   * `terminal.integrated.windowsEnableConpty` - Whether to use ConPTY for Windows terminal process communication.
   ...
   ![Search for Integrated terminal settings](/assets/search-for-settings-71b69zk7uwzb.png)
   ...
   ![Filter for modified settings](/assets/search-for-modified-settings-tcxxzay4m0qq.png)
   ...
   ![A user's settings.json file](/assets/settings-json-file-bywv3ch4k9nl.png)
...
![Use legacy mode checkbox](/assets/legacy-console-mode-6pu322d6i9y9.png)

## Next steps

* [[vs.1.7.docs.terminal.basics]] - Learn more about general terminal use and configuration.
