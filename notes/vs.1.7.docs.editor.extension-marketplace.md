...
MetaDescription: >-
  Discover, add, update, disable and uninstall Visual Studio Code extensions
  (plug-ins) through the Extension Marketplace.
---
...
![Extensions view icon](/assets/extensions-view-icon-in00yjqpnuqw.png)
...
![popular extensions](/assets/extensions-popular-lmgt5y2gmguo.png)
...
> **Note:** If your computer's Internet access goes through a proxy server, you will need to configure the proxy server. See [[vs.1.7.docs.setup.network.md#proxy-server-support]] for details.
...
![TODO Highlight extension highlighting in the editor](/assets/todo-highlighting-t1mpkkm4ggsl.png)
...
![Search for todo in the Extensions view](/assets/search-for-todo-extension-op0ppi67ufsz.png)
...
![TODO Highlight extension details with extension ID highlighted](/assets/todo-highlight-details-mfm6nyf6mlex.png)
...
![Manage gear button](/assets/manage-button-aijjwwfrtuyo.png)
...
![TODO Highlight commands in the Command Palette](/assets/todo-highlight-commands-0hnv1qbn8jan.png)
...
![TODO Highlight settings in the Settings editor](/assets/todo-highlight-settings-sfa3296zymg0.png)
...
![Uninstall the TODO Highlight extension](/assets/todo-highlight-uninstall-76ncjkzkoqso.png)
...
![extension contributions](/assets/extension-contributions-553hnhz9z95n.png)

If an extension is an Extension Pack, the **Extension Pack** section will display which extensions will be installed when you install the pack. [[vs.1.7.api.references.extension-manifest.md#extension-packs]] bundle separate extensions together so they can be easily installed at one time.

![Azure Tools extension pack](/assets/extension-pack-cno4wnutbq6t.png)

### Extensions view filter and commands

You can filter the Extensions view with the **Filter Extensions** context menu.

![Extensions view filter context menu](/assets/extensions-view-filter-menu-ghdd31l624p7.png)
...
![more button](/assets/more-button-5mnchoqommq8.png)
...
![more dropdown](/assets/more-dropdown-yprk5pt94tfv.png)
...
![uninstall an extension](/assets/uninstall-extension-u8d8a8r06x47.png)
...
![extension identifier](/assets/extension-identifier-tpbj9o7kv8ln.png)
...
![intellisense on extension search filters](/assets/extension-search-filters-jwnk8icogrnu.png)
...
![sort by install count](/assets/sort-install-count-i3lueklf71sz.png)

### Categories and tags

Extensions can set **Categories** and **Tags** describing their features.

![extension categories and tags](/assets/categories-and-tags-1cuy619dkq29.png)
...
![categories debuggers](/assets/extension-search-categories-sd1tbj0fe5x4.png)
...
If you'd like to learn more about packaging and publishing extensions, see our [[vs.1.7.api.working-with-extensions.publishing-extension]] article in the Extension API.
...
In a [[vs.1.7.docs.editor.multi-root-workspaces]], the command will open your `.code-workspace` file where you can list extensions under `extensions.recommendations`. You can still add extension recommendations to individual folders in a multi-root workspace by using the **Extensions: Configure Recommended Extensions (Workspace Folder)** command.
...
![Show Recommendations](/assets/recommendations-jixayn4aqoe9.png)

## Next steps

Here are a few topics you may find interesting...

* [[vs.1.7.api]] - Start learning about the VS Code extension API.
* [[vs.1.7.api.get-started.your-first-extension]] - Try creating a simple Hello World extension.
* [[vs.1.7.api.working-with-extensions.publishing-extension]] - Publish your own extension to the VS Code Marketplace.
...
You can change the location by launching VS Code with the `--extensions-dir <dir>` command-line [[vs.1.7.docs.editor.command-line]].

### Whenever I try to install any extension, I get a connect ETIMEDOUT error

You may see this error if your machine is going through a proxy server to access the Internet.  See the [[vs.1.7.docs.setup.network.md#proxy-server-support]] section in the setup topic for details.
