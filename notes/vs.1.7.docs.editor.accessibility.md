...
MetaDescription: >-
  Visual Studio Code user accessibility features.  Learn here about the various
  ways VS Code aids user accessibility.
---
# Accessibility
...
![Zoomed in editor](/assets/zoomed-in-gvmknjyfcoz4.png)

### Persisted Zoom Level

When you adjust the zoom level with the **View** > **Zoom In / Out** commands, the zoom level is persisted in the `window.zoomLevel` [[vs.1.7.docs.getstarted.settings]]. The default value is 0 and each increment/decrement changes the zoom level by 20%.
...
![High Contrast Theme](/assets/high-contrast-usxkmmjkseo3.png)
...
![Visual Studio Marketplace in VS Code UI](/assets/accessibility-extension-marketplace-6qvaewwbmwjh.png)

Once you have installed a color theme from the Marketplace, you can change the [[vs.1.7.docs.getstarted.themes]] with **File** > **Preferences** > **Color Theme** (**Code** > **Preferences** > **Color Theme** on macOS) `kb(workbench.action.selectTheme)`.

![Dropdown for Select Color Theme](/assets/accessibility-select-theme-jq10gz0g620h.png)
...
>**Note**: Visit [[vs.1.7.docs.getstarted.themes.md#customizing-a-color-theme]] to learn more about overriding the colors in your current theme.
...
![JSON file settings icon](/assets/accessibility-settings-json-file-518bnu1m8973.png)
...
![JSON code to alter error/warning squiggle colors](/assets/accessibility-extension-squiggles-1d6onmuqof3d.png)
...
![Color wheel highlighting complementary colors](/assets/accessibility-color-wheels-w45ju23lqys0.png)
...
![Keyboard shortcuts in Command Palette](/assets/keyboard-shortcuts-h6l6k9nc59l1.png)
...
![tab moves focus](/assets/tab-moves-focus-e88euqov7hcb.png)
...
![accessibility status](/assets/status-7nu1eznlagsr.png)
...
![screen reader optimized mode](/assets/screen-reader-mode-c7audywc95yd.png)
