---
id: w9aynt5rvjev869pbl8pmqn
title: Settings
desc: ''
updated: 1660824078447
created: 1660824078447
isDir: false
Order: 6
Area: getstarted
TOCTitle: Settings
...
In this article, we'll first describe user settings as these are your personal settings for customizing VS Code. Later we'll cover [[vs.1.7.#workspace-settings]], which will be specific to the project you're working on.
...
![Filtering settings by searching in the Settings editor](/assets/settings-search-hhtsjlzgkqfq.png)

In the example below, the Side Bar location and file icon theme have been changed.

![Modified settings in the Settings editor showing blue vertical bars to the left of them](/assets/settings-modified-zxss7da3cq12.png)
...
![Settings edit gear context menu](/assets/more-actions-context-menu-ahqep0v6vxdl.png)
...
![An example setting with a dropdown](/assets/settings-edit-etqzpkvtnihy.png)
...
![Settings editor with the Source Control section of the table of contents selected](/assets/settings-groups-jqg8sx5ia9vq.png)
...
![Activity Bar display on the left of the editor](/assets/activity-bar-571aoyjfnvlj.png)
...
![Settings editor with 'activity' in the Search bar with at least five settings](/assets/search-for-activity-on1mqvgriivb.png)
...
![Activity Bar: Visible unchecked and Activity Bar is hidden](/assets/activity-bar-hidden-3rcqdmglwqaa.png)
...
![Settings editor with @modified filter showing changed settings](/assets/modified-filter-settings-u3rquqs39oti.png)

### Other filters

There are several other handy filters to help with searching through settings.

![Setting editor @ tag filter dropdown](/assets/settings-editor-filters-77auhz821t77.png)
...
* `@lang` - Apply a language filter based on a language ID. For example, `@lang:typescript`. See [[vs.1.7.#language-specific-editor-settings]] for more details.
* `@tag` - Settings specific to a system of VS Code. For example, `@tag:workspaceTrust` for settings related to [[vs.1.7.docs.editor.workspace-trust]]
...
![Clear Settings Search Input button in the right of the Settings editor](/assets/clear-search-input-button-3mkmign07miz.png)
...
![C++ extension settings in the Settings editor](/assets/cpp-extension-settings-l57vtr1ii116.png)
...
![Python extension Settings list under Feature Contributions tab](/assets/python-feature-contributions-09j3vi3ppwhu.png)

Extension authors can learn more about adding custom settings in the [[vs.1.7.api.references.contribution-points.md#contributes.configuration]].
...
![User settings.json open in the editor](/assets/settings-json-in-editor-a0vffymmutp6.png)
...
![IntelliSense for settings.json open in the editor](/assets/settings-json-intellisense-mlamukaz7gck.png)
...
![Workbench: Color Customizations setting with Edit in settings.json link](/assets/edit-in-settings-json-link-j8o1poab2u64.png)
...
![settings.json editor with green line numbers](/assets/color-customization-example-2xmnvn9593rm.png)

Remove the `workbench.colorCustomizations` setting code block to return the line number color to the default.

>**Note**: The example above changes the editor line number for all [[vs.1.7.docs.getstarted.themes]], but you can tune colors per [[v[[vs.1.7.docs.getstarted.themes.md#customizing-a-color-theme]] even [[v[[vs.1.7.api.extension-guides.color-theme.md#create-a-new-color-theme]]tension.
...
>**Note**: A VS Code "workspace" is usually just your project root folder. Workspace settings as well as [[vs.1.7.docs.editor.debugging]] and [[v[[vs.1.7.docs.editor.tasks]]nfigurations are stored at the root in a `.vscode` folder. You can also have more than one root folder in a VS Code workspace through a feature called [[vs.1[[vs.1.7.docs.editor.multi-root-workspaces]]can learn more in the [[vs.1.7.[[vs.1.7.docs.editor.workspaces]]
...
![Settings editor with Workspace tab highlighted](/assets/settings-editor-workspace-tab-kbv4gzttsc30.png)
...
![The File Explorer displaying settings.json under the .vscode folder](/assets/settings-json-under-vscode-phfp1frutm2h.png)

>**Note:** For a [[vs.1.7.docs.editor.multi-root-workspaces.md#settings]], workspace settings are located inside the workspace configuration file.
...
![Editing the CSS-specific user-scoped diffEditor.codeLens setting in the Settings editor](/assets/settings-css-example-qulxora1ek1v.png)
...
![Configure language-specific settings command typed up in the Command Palette](/assets/pref-config-lang-settings-1xgj328oggk7.png)

Select the language via the dropdown:

![Select language dropdown](/assets/lang-selection-zgah6z6s6v9c.png)

Now you can start editing settings specifically for that language:

![Settings editor showing a specific language filter](/assets/lang-based-settings-editor-gdb75t8bsi5q.png)

Or, if `workbench.settings.editor` is set to `json`, now you can start adding language-specific settings to your user settings:

![Suggestions for language-specific settings shown in the settings JSON file](/assets/lang-based-settings-q5w53l6c5o9c.png)
...
* Workspace Folder settings - Apply to a specific folder of a [[vs.1.7.docs.editor.multi-root-workspaces]].
