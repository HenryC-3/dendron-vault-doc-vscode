...
![refactoring hero image](/assets/refactoring-hero-gowbrdrk5q5k.png)
...
>**Note:** If you prefer to not see the Code Action lightbulb in your editor, you can disable lightbulbs with the `editor.lightbulb.enable` [[vs.1.7.docs.getstarted.settings]]. You can still open Quick Fixes through **Quick Fix** command and `kb(editor.action.quickFix)` keyboard shortcut.
...
![Extract local](/assets/ts-extract-local-y8kki1zx0ton.gif)
...
![Rename](/assets/rename-rijswb6exjbl.png)
...
![Select Code Action context menu](/assets/code-action-context-menu-z245lvbi5lch.png)
...
* [[vs.1.7.docs.editor.editingevolved]] - VS Code lets you move quickly through your source code.
* [[vs.1.7.docs.editor.debugging]] - Learn about debugging with VS Code.
