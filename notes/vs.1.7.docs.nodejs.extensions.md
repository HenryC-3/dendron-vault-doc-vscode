...
MetaDescription: >-
  Learn more about installing and integrating JavaScript and Node.js extensions
...
> **Tip:** To see how to install and manage your extensions, please refer to the [[vs.1.7.docs.editor.extension-marketplace]].
...
Read more about setting up JavaScript linters in the VS Code [[vs.1.7.docs.languages.javascript.md#linters]].

![ESLint animation](/assets/eslint-ch0s87vi3eko.gif)
...
![SonarLint animation](/assets/sonarlint-323b9g06tx9q.gif)
...
![npm intellisense](/assets/npm_intellisense-yvpjhqaycysu.gif)
