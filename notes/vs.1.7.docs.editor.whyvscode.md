...
MetaDescription: >-
  Visual Studio Code provides developers with a new choice of tool that combines
  the simplicity of a code editor with the best tooling for their core
  edit-build-debug cycle. Visual Studio Code is available for macOS, Linux, and
  Windows.
---
...
![Visual Studio Code runs on macOS, Linux and Windows](/assets/macwinlinux2-2bpcmb7uslld.png)
...
* [[vs.1.7.docs.getstarted.introvideos]] - Learn about the VS Code editor features.
* [[vs.1.7.docs.editor.debugging]] - OK time for the really fun stuff - break, step, watch.
