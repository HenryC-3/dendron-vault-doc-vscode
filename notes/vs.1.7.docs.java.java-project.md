...
MetaDescription: >-
  Lightweight Mode, Maven Support, Java Package and Dependency Management in
  Visual Studio Code
...
![project view](/assets/projectmanager-overview-ememhiayvlsh.png)
...
![overflow button](/assets/overflow-button-4ut3st4fr4ct.png)

You can find buttons next to the nodes in the Explorer, which provide useful shortcuts for some actions.

![inline button](/assets/inline-button-qzaf35lpfg54.png)
...
![context menu](/assets/context-menu-9uf1bzz7ii99.png)
...
![create project](/assets/projectmanager-createproject-ek5fwndhg4hk.png)
...
![Export jar from the project view](/assets/exportjar-ksewu78dp3b8.gif)
...
![Project runtime](/assets/configure-project-runtime-qllccopvcydw.png)
...
![Download-jdk](/assets/download-jdk-5erd3rwuvaiv.png)

> **Note**: To enable Java preview features, see [[vs.1.7.docs.java.java-faq.md#how-can-i-use-visual-studio-code-with-new-java-versions]].
...
![configure classpath](/assets/configure-classpath-037f68k7y61d.png)
...
![add maven dependency](/assets/add-maven-dependency-p7949ikx64w0.png)
...
![Switch to Standard](/assets/switch-to-standard-7fczrillg6qp.gif)
...
- [[vs.1.7.docs.java.java-editing]] - Explore the editing features for Java in VS Code.
- [[vs.1.7.docs.java.java-debugging]] - Find out how to debug your Java project with VS Code.
- [[vs.1.7.docs.java.java-testing]] - Use VS Code for your JUnit and TestNG cases.
