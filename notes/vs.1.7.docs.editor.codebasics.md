...
MetaDescription: >-
  Learn about the basic editing features of Visual Studio Code. Search, multiple
...
* [[vs.1.7.docs.getstarted.keybindings.md#keyboard-shortcuts-reference]] - Learn the most commonly used and popular keyboard shortcuts by downloading the reference sheet.
* [[vs.1.7.docs.getstarted.keybindings.md#keymap-extensions]] - Use the keyboard shortcuts of your old editor (such as Sublime Text, Atom, and Vim) in VS Code by installing a Keymap extension.
* [[vs.1.7.docs.getstarted.keybindings.md#keyboard-shortcuts-editor]] - Change the default keyboard shortcuts to fit your style.
...
![Multi-cursor](/assets/multicursor-aywb2750rkhh.gif)
...
![Multi-cursor-next-word](/assets/multicursor-word-t15r93w4zxrg.gif)
...
If you'd like to change the modifier key for applying multiple cursors to `kbstyle(Cmd+Click)` on macOS and `kbstyle(Ctrl+Click)` on Windows and Linux, you can do so with the `editor.multiCursorModifier` [[vs.1.7.docs.getstarted.settings]]. This lets users coming from other editors such as Sublime Text or Atom continue to use the keyboard modifier they are familiar with.
...
![Expand selection](/assets/expandselection-y8c3f7pgr2hb.gif)
...
You can [[vs.1.7.docs.getstarted.keybindings]] your `keybindings.json` to bind them to something more familiar if you want.
...
For more control over `Auto Save`, open User or Workspace [[vs.1.7.docs.getstarted.settings]] and find the associated settings:
...
![Seed Search String From Selection](/assets/seed-search-string-from-selection-q8lv9kuddqo2.gif)
...
![Find In Selection](/assets/find-in-selection-sqekxuyqxsvx.gif)
...
![Multiple Line Support](/assets/multiple-line-support-fxq2xbidyb8d.gif)
...
![Resize Find Widget](/assets/resize-find-widget-mckxa5fsffzj.gif)
...
![A simple text search across files](/assets/search-h20hruwyyryy.png)
...
![Advanced search options](/assets/searchadvanced-efbxzz5e3ggf.png)
...
VS Code excludes some folders by default to reduce the number of search results that you are not interested in (for example: `node_modules`). Open [[vs.1.7.docs.getstarted.settings]] to change these rules under the `files.exclude` and `search.exclude` section.
...
![search and replace](/assets/global-search-replace-yfqf2m3zzkam.png)

When you type text into the Replace text box, you will see a diff display of the pending changes. You can replace across all files from the Replace text box, replace all in one file or replace a single change.

![search and replace diff view](/assets/search-replace-example-kulogb626dj1.png)
...
![Changing case while doing find and replace](/assets/case-change-replace-iawts8lct9zx.gif)
...
![Search Editor overview](/assets/search-editor-overview-hzt35lojnygr.png)
...
![Search Editor Button](/assets/search-editor-button-ogqhqwmlr0w7.png)
...
> **Tip:** IntelliSense suggestions can be configured via the `editor.quickSuggestions` and `editor.suggestOnTriggerCharacters` [[vs.1.7.docs.getstarted.settings]].

JavaScript and TypeScript developers can take advantage of the [npmjs](https://www.npmjs.com) type declaration (typings) file repository to get IntelliSense for common JavaScript libraries (Node.js, React, Angular). You can find a good explanation on using type declaration files in the [[vs.1.7.docs.languages.javascript.md#intellisense]] topic and the [[vs.1.7.docs.nodejs.nodejs-tutorial]] tutorial.

Learn more in the [[vs.1.7.docs.editor.intellisense]].
...
VS Code has default formatters for JavaScript, TypeScript, JSON, and HTML. Each language has specific formatting options (for example, `html.format.indentInnerHtml`) which you can tune to your preference in your user or workspace [[vs.1.7.docs.getstarted.settings]]. You can also disable the default language formatter if you have another extension installed that provides formatting for the same language.

```json
"html.format.enable": false
```

Along with manually invoking code formatting, you can also trigger formatting based on user gestures such as typing, saving or pasting. These are off by default but you can enable these behaviors through the following [[vs.1.7.docs.getstarted.settings]]:
...
![Folding](/assets/folding-cnmjobs2k2sx.png)
...
VS Code lets you control text indentation and whether you'd like to use spaces or tab stops. By default, VS Code inserts spaces and uses 4 spaces per `kbstyle(Tab)` key. If you'd like to use another default, you can modify the `editor.insertSpaces` and `editor.tabSize` [[vs.1.7.docs.getstarted.settings]].
...
![auto detect indentation](/assets/indentation-detection-vfx361r00gu8.png)
...
![indentation commands](/assets/indentation-commands-t2a6bqomnox6.png)
...
![files.encoding setting](/assets/filesencodingsetting-6x9mmdy2p3ik.png)

You can view the file encoding in the status bar.

![Encoding in status bar](/assets/fileencoding-dpskfbp8538f.png)

Click on the encoding button in the status bar to reopen or save the active file with a different encoding.

![Reopen or save with a different encoding](/assets/encodingclicked-jlbmmad4uk51.png)

Then choose an encoding.

![Select an encoding](/assets/encodingselection-yb6107ohscd7.png)

## Next steps

You've covered the basic user interface - there is a lot more to VS Code.  Read on to find out about:

* [[vs.1.7.docs.introvideos.basics]] - Watch a tutorial on the basics of VS Code.
* [[vs.1.7.docs.getstarted.settings]] - Learn how to configure VS Code to your preferences through user and workspace settings.
* [[vs.1.7.docs.editor.editingevolved]] - Peek and Goto Definition, and more.
* [[vs.1.7.docs.terminal.basics]] - Learn about the integrated terminal for quickly performing command-line tasks from within VS Code.
* [[vs.1.7.docs.editor.intellisense]] - VS Code brings smart code completions.
...
![global search and replace](/assets/global-search-replace-yfqf2m3zzkam.png)

### How do I turn on word wrap?

You can control word wrap through the `editor.wordWrap` [[vs.1.7.docs.getstarted.settings]]. By default, `editor.wordWrap` is `off` but if you set to it to `on`, text will wrap on the editor's viewport width.
