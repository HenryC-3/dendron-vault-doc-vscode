...
MetaDescription: >-
  Java web app tutorial showing how to build and deploy a Java web app to Azure
...
Let's now edit `HelloController.java` to change "Greetings from Spring Boot!" to something else like "Hello World". VS Code provides a great editing experience for Java, check out [[vs.1.7.docs.java.java-editing]] to learn about VS Code's editing and code navigation features.
...
![Create a Web App](/assets/create-webapp-b5yukjz0joor.png)
...
![Deploy to Web App](/assets/deploy-webapp-eq32m5dlls1w.png)
...
![Greeting from Spring Boot](/assets/greeting-b7sougxypsrn.png)
...
After setting a breakpoint (`kb(editor.debug.action.toggleBreakpoint)`) in your source code, refresh your browser to hit the breakpoint. Details about debugging can be found in [[vs.1.7.docs.java.java-debugging]]
...
- To containerize and deploy a web application, check out the [[vs.1.7.docs.containers.overview]].
- To learn more about Java Debugging features, see the [[vs.1.7.docs.java.java-debugging]].
