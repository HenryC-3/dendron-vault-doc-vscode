...
![Working with JavaScript in Visual Studio Code](/assets/overview-obmyi1dtauj5.png)

Most of these features just work out of the box, while some may require basic configuration to get the best experience. This page summarizes the JavaScript features that VS Code ships with. Extensions from the [VS Code Marketplace](https://marketplace.visualstudio.com) can augment or change most of these built-in features. For a more in-depth guide on how these features work and can be configured, see [[vs.1.7.docs.nodejs.working-with-javascript]].
...
See [[vs.1.7.docs.nodejs.working-with-javascript]] for information about VS Code's JavaScript IntelliSense, how to configure it, and help troubleshooting common IntelliSense problems.

## JavaScript projects (jsconfig.json)

A [[vs.1.7.docs.languages.jsconfig]] file defines a JavaScript project in VS Code. While `jsconfig.json` files are not required, you will want to create one in cases such as:
...
See [[vs.1.7.docs.nodejs.working-with-javascript]] for more advanced `jsconfig.json` configuration.
...
VS Code includes basic JavaScript [[vs.1.7.docs.editor.userdefinedsnippets]] that are suggested as you type;
...
There are many extensions that provide additional snippets, including snippets for popular frameworks such as Redux or Angular. You can even [[vs.1.7.docs.editor.userdefinedsnippets]].

> **Tip**: To disable snippets suggestions, set `editor.snippetSuggestions` to `"none"` in your [[vs.1.7.docs.getstarted.settings]] file. The `editor.snippetSuggestions` setting also lets you change where snippets appear in the suggestions: at the top (`"top"`), at the bottom (`"bottom"`), or inlined ordered alphabetically (`"inline"`). The default is `"inline"`.
...
![Hovering over a JavaScript variable to see its type information](/assets/hover-hzkr5o6nhauu.png)
...
![Signature help for some DOM methods](/assets/signature-help-fz8j009t6fa0.png)
...
![After selecting a symbol from a different file, an import is added for it automatically](/assets/auto-import-after-lkji4c4mx3sv.png)
...
The `javascript.format.*` [[vs.1.7.docs.getstarted.settings]] configure the built-in formatter. Or, if the built-in formatter is getting in the way, set `"javascript.format.enable"` to `false` to disable it.
...
![JSX IntelliSense](/assets/jsx-dtt7xwctpxat.png)
...
![Renaming a variable](/assets/rename-6i8l3hwjbj5v.png)
...
![JavaScript refactoring](/assets/refactorings-alqyypmaux8e.png)
...
See [[vs.1.7.docs.editor.refactoring]] for more information about refactorings and how you can configure keyboard shortcuts for individual refactorings.
...
![Unreachable source code faded out](/assets/unreachable-p1mqb3e6cedz.png)
...
See [[vs.1.7.docs.nodejs.working-with-javascript]] for more information.
...
![Parameter name inlay hints](/assets/inlay-parameters-8smjglimu8u5.png)
...
![Variable type inlay hints](/assets/inlay-var-types-pfwi03xoh4u0.png)
...
![Property type inlay hints](/assets/inlay-property-types-zbslb7dn7ecn.png)

**Parameter type hints**  show the types of implicitly typed parameters.

Setting: `javascript.inlayHints.parameterTypes.enabled`

![Parameter type inlay hints](/assets/inlay-parameter-types-62x5yi3j58r7.png)
...
![Return type inlay hints](/assets/inlay-return-type-8vskwfxuyks7.png)
...
![JavaScript references CodeLens](/assets/references-codelens-cvd6bfg41p34.png)

To enable the references CodeLens, set `"javascript.referencesCodeLens.enabled"` to `true`.

Click on the reference count to quickly browse a list of references:

![JavaScript references CodeLens peek](/assets/references-codelens-peek-nja6ums3phpl.png)
...
[Linters](https://en.wikipedia.org/wiki/Lint_%28software%29) provides warnings for suspicious looking code. While VS Code does not include a built-in JavaScript linter, many JavaScript linter [[vs.1.7.docs.editor.extension-marketplace]] available in the marketplace.
...
![Using type checking and Quick Fixes in a JavaScript file](/assets/checkjs-example-dxwkiciell57.gif)

TypeScript tried to infer types in `.js` files the same way it does in `.ts` files. When types cannot be inferred, they can be specified explicitly with JSDoc comments. You can read more about how TypeScript uses JSDoc for JavaScript type checking in [[vs.1.7.docs.nodejs.working-with-javascript]].
...
VS Code comes with great debugging support for JavaScript. Set breakpoints, inspect objects, navigate the call stack, and execute code in the Debug Console. See the [[vs.1.7.docs.editor.debugging]] to learn more.
...
Debug Node.js in VS Code using the built-in debugger. Setup is easy and there is a [[vs.1.7.docs.nodejs.nodejs-tutorial.md#debug-your-express-app]] to help you.

![debug data inspection](/assets/debug_data_inspection-suuu8pnjyez3.gif)

## Popular extensions

VS Code ships with excellent support for JavaScript but you can additionally install debuggers, snippets, linters, and other JavaScript tools through [[vs.1.7.docs.editor.extension-marketplace]].
...
* [[vs.1.7.docs.nodejs.working-with-javascript]] - More detailed information about VS Code's JavaScript support and how to troubleshoot common issues.
* [[vs.1.7.docs.languages.jsconfig]] - Detailed description of the `jsconfig.json` project file.
* [[vs.1.7.docs.editor.intellisense]] - Learn more about IntelliSense and how to use it effectively for your language.
* [[vs.1.7.docs.editor.debugging]] - Learn how to set up debugging for your application.
* [[vs.1.7.docs.nodejs.nodejs-tutorial]] - A walkthrough to create an Express Node.js application.
* [[vs.1.7.docs.languages.typescript]] - VS Code has great support for TypeScript, which brings structure and strong typing to your JavaScript code.
...
Yes, but some of [Flow's](https://flow.org) language features such as type and error checking may interfere with VS Code's built-in JavaScript support. To learn how to disable VS Code's built-in JavaScript support, see [[vs.1.7.docs.nodejs.working-with-javascript.md#disable-javascript-support]].
