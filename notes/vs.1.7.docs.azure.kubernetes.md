...
![Install Kubernetes](/assets/install-kubernetes-upvux81le8ye.png)

## Containerize and publish the application

You can follow the [[vs.1.7.docs.azure.docker]] tutorial to build your project, generate a Docker image, and push it to a public or private container registry through the Microsoft [Docker Extension](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-docker).
...
![Create Kubernetes](/assets/create-k8s-q369dld3zzqf.gif)
...
![Error with RSA](/assets/error-creating-clusters-rsa-41off3m34xfx.png)
...
![Error creating cluster](/assets/error-creating-clusters-wjhqy0xfhlce.png)
...
![Create manifest](/assets/create-manifest-8oa5ltk21grk.gif)

Below is an example manifest file:

![Manifest example](/assets/manifest-example-laqizwb5f5vw.png)
...
![Start deployment](/assets/start-deployment-evbs3do5rfb4.gif)
...
![Check status](/assets/check-status-adgalhowf5m5.gif)
