...
![HTML IntelliSense](/assets/htmlintellisense-q395dr8camai.png)
...
You can also control which built-in code completion providers are active. Override these in your user or workspace [[vs.1.7.docs.getstarted.settings]] if you prefer not to see the corresponding suggestions.
...
![HTML Close1](/assets/auto-close1-gcqjdb7fesan.gif)

The matching closing tag is inserted when `/` of the closing tag is entered.

![HTML Close2](/assets/auto-close2-urr5oy8x0llf.gif)

You can turn off autoclosing tags with the following [[vs.1.7.docs.getstarted.settings]]:
...
![color picker in HTML](/assets/color-picker-html-a25c42ro8yju.png)
...
![HTML Hover](/assets/htmlhover-43yd8aicsaoq.png)
...
The HTML formatter is based on [js-beautify](https://www.npmjs.com/package/js-beautify). The formatting options offered by that library are surfaced in the VS Code [[vs.1.7.docs.getstarted.settings]]:
...
![Emmet HTML support built-in](/assets/emmetsnippet-lrhfpfpe6b8l.gif)

>**Tip:** See the HTML section of the [Emmet cheat sheet](https://docs.emmet.io/cheat-sheet) for valid abbreviations.

If you'd like to use HTML Emmet abbreviations with other languages, you can associate one of the Emmet modes (such as `css`, `html`) with other languages with the `emmet.includeLanguages` [[vs.1.7.docs.getstarted.settings]]. The setting takes a [[v[[vs.1.7.docs.languages.overview.md#language-identifier]]d associates it with the language ID of an Emmet supported mode.
...
We also support [[vs.1.7.docs.editor.userdefinedsnippets]].
...
* [[vs.1.7.docs.languages.css]] - VS Code has first class support for CSS including Less and SCSS.
* [[vs.1.7.docs.editor.emmet]] - Learn about VS Code's powerful built-in Emmet support.
