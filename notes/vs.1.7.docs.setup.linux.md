...
See the [[vs.1.7.download]] page for a complete list of available installation options.
...
Note that other binaries are also available on the [[vs.1.7.download]].
...
[![Get it from the Snap Store](/assets/snap-store-ju86rbvawezx.png)](https://snapcraft.io/code)
...
Node.js is a popular platform and runtime for easily building and running JavaScript applications. It also includes [npm](https://www.npmjs.com/), a Package Manager for Node.js modules. You'll see Node.js and npm mentioned frequently in our documentation and some optional VS Code tooling requires Node.js (for example, the VS Code [[vs.1.7.api.get-started.your-first-extension]]).
...
To learn more about JavaScript and Node.js, see our [[vs.1.7.docs.nodejs.nodejs-tutorial]], where you'll learn about running and debugging Node.js applications with VS Code.
...
See the [[vs.1.7.docs.remote.wsl]] documentation to learn more or try the [[v[[vs.1.7.docs.remote.wsl-tutorial]]troductory tutorial.
