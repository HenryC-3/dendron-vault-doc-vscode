...
Visual Studio Code can be a great companion to Unity for editing C# files.  All of the [[vs.1.7.docs.languages.csharp]] features are supported and more.  In the screen below, you can see code colorization, bracket matching, IntelliSense, CodeLens and that's just the start.

![Unity Example](/assets/wow-kpohahuxxhva.gif)

Read on to find out how to configure Unity and your project to get the best possible experience.

## Prerequisites

From [[vs.1.7.docs.languages.dotnet]]:
...
1. In the VS Code Settings editor (`kb(workbench.action.openSettings)`), uncheck the C# extension's **Omnisharp: Use Modern Net** [[vs.1.7.docs.getstarted.settings]] (`"omnisharp.useModernNet": false`).
...
![Unity Preferences](/assets/unity_preferences_external_script_editor-631kyefgue9q.gif)
...
Two topics that will help you are [[vs.1.7.docs.editor.codebasics]] and [[v[[vs.1.7.docs.languages.csharp]]n the image below, you can see VS Code showing hover context, peeking references and more.

![editing evolved example](/assets/peekreferences-ti4wjdigqu59.png)
...
* [[vs.1.7.docs.languages.csharp]] - learn about the C# support in VS Code
...
![OmniSharp Flame on the Status Bar](/assets/omnisharp-pi6d86pu3vme.png)

Choose the `-CSharp` version of the solution file and VS Code will light up.

![Choose Solution](/assets/selectsln-0x00bstjqwc5.png)
...
To do this, add the following JSON to your [[vs.1.7.docs.getstarted.settings]]. By adding these excludes to your workspace settings, you will not change your global user settings and it allows anyone also working on the project to have the same file excludes.
...
Before|After
------|-----
![Unfiltered files](/assets/unfilteredfiles-8luxfjkdch![filtered files](/assets/filteredfiles-ezd3rb6jn6r5.png)les.png)
