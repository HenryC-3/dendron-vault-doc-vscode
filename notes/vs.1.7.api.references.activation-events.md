...
**Activation Events** is a set of JSON declarations that you make in the `activationEvents` field of `package.json` [[vs.1.7.api.references.extension-manifest]]. Your extension becomes activated when the **Activation Event** happens. Here is a list of all available **Activation Events**:

- [[vs.1.7.api.references.activation-events#onLanguage]]
- [[vs.1.7.api.references.activation-events#onCommand]]
- [[vs.1.7.api.references.activation-events#onDebug]]
  - [[vs.1.7.api.references.activation-events#onDebugInitialConfigurations]]
  - [[vs.1.7.api.references.activation-events#onDebugResolve]]
- [[vs.1.7.api.references.activation-events#workspaceContains]]
- [[vs.1.7.api.references.activation-events#onFileSystem]]
- [[vs.1.7.api.references.activation-events#onView]]
- [[vs.1.7.api.references.activation-events#onUri]]
- [[vs.1.7.api.references.activation-events#onWebviewPanel]]
- [[vs.1.7.api.references.activation-events#onCustomEditor]]
- [[vs.1.7.api.references.activation-events#onAuthenticationRequest]]
- [[vs.1.7.api.references.activation-events#onStartupFinished]]
- [[vs.1.7.api.references.activation-events#Start-up]]

We also provide a reference of all fields in the [[vs.1.7.api.references.extension-manifest]].
...
The `onLanguage` event takes a [[vs.1.7.docs.languages.identifiers]] value.
...
This activation event is emitted and interested extensions will be activated whenever VS Code needs to restore a [[vs.1.7.api.extension-guides.webview]] with the matching `viewType`.
...
This activation event is emitted and interested extensions will be activated whenever VS Code needs to create a [[vs.1.7.api.extension-guides.custom-editors]] with the matching `viewType`.
...
will cause the extension to be activated when VS Code needs to restore a custom editor with the viewType: `catCustoms.pawDraw`. The viewType is set in the [[vs.1.7.api.extension-guides.custom-editors#contribution-point]] and bound to a provider with `registerCustomEditorProvider`.
