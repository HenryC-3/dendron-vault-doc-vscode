...
> **Insiders:** If you are using the VS Code [[vs.1.7.insiders]] preview, you launch your Insiders build with `code-insiders`.
...
![go to line and column](/assets/goto-line-column-b545i7dhobh4.png)
