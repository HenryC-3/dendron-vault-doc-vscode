---
id: u84k6xmg4nbvdxqqc1cvqzh
title: Versioncontrol
desc: ''
updated: 1660824078446
created: 1660824078446
isDir: false
Order: 8
Area: editor
...
Visual Studio Code has integrated source control management (SCM) and includes [Git](https://git-scm.com/) support out-of-the-box. Many other source control providers are available through [[vs.1.7.docs.editor.extension-marketplace]] on the VS Code Marketplace.
...
![Source Control Repositories view option in overflow menu](/assets/scm-providers-list-fwu6un6xupie.png)
...
![SCM Provider category in the marketplace](/assets/scm-provider-category-jqq4h9yq1if6.png)
...
![Overview of Git](/assets/overview-58u5l800k5on.png)
...
![Stage all changes button](/assets/stage-changes-sqiedrctpyt9.png)
...
![views and more actions button](/assets/scm-more-actions-wfwk22xw690x.png)
...
![First run Source Control experience](/assets/firstrun-source-control-pwu9tqd4rg9p.png)
...
![clone repository dialog](/assets/github-clone-dialog-t2u2mb4f7zpa.png)

You would then paste that URL into the **Git: Clone** prompt.

![set repository URL](/assets/set-repo-url-7dvke8reeear.png)
...
>**Note**: If you'd like to work on a repository without cloning the contents to your local machine, you can install the [GitHub Repositories](https://marketplace.visualstudio.com/items?itemName=github.remotehub) extension to browse and edit directly on GitHub. You can learn more in the [[vs.1.7.docs.editor.github.md#github-repositories-extension]] section.
...
![Git checkout](/assets/gitbranches-45y83ik9yk63.png)
...
![Gutter indicators](/assets/gutter-do5hkojr1v8s.png)

## Merge conflicts

![Git merge](/assets/merge-conflict-rri33v3gje01.png)
...
![A File Diff in VS Code](/assets/diff-plziek682dl3.png)
...
![diff-review-pane](/assets/diff-review-pane-hnnc40rtuwcf.png)
...
![Timeline view](/assets/timeline-view-1q4qtmdordjh.png)
...
Visual Studio Code supports more Git history workflows through [[vs.1.7.docs.editor.extension-marketplace]] available on the VS Code Marketplace.
...
![Git initialize repository](/assets/initialize-repository-pe9f8eoldaji.png)
...
* [[vs.1.7.docs.introvideos.versioncontrol]] - An introductory video providing an overview of VS Code Git support.
...
* [[vs.1.7.api.extension-guides.scm-provider]] - If you want to integrate another Source Control provider into VS Code, see our Source Control API.
