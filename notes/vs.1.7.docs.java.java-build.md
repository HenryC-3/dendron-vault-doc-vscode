...
![Maven Explorer](/assets/maven-explorer-pujog4b5a76j.png)
...
1. From the Maven Explorer, select the **+** **Create Maven Project** button.
   ...
   ![Create Maven Project](/assets/create-maven-project-5ixjtxai8ohw.png)
...
![Gradle Dependencies](/assets/gradle-dependencies-re745t4nappw.png)
...
![Gradle Highlighting](/assets/gradle-highlighting-vot9ozcpwp6w.png)
...
![Gradle Outline](/assets/gradle-outline-4iiy1e8karlv.png)
...
![Gradle Problems](/assets/gradle-problems-m5pnf39rxhaf.png)
